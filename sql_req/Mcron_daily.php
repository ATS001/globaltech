...
$terminison_file = '_job_cron_day.php';
...
{
	$file = MPATH_INCLUDES.SLASH.'log_cron_daily.log';
	$line = '['.date('d-m-Y H:i:s').']: '.$log.' =>'.MPATH_CRON_JOB.$current_job.'_cron_job_day.php'.PHP_EOL;
