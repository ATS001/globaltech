...
INSERT INTO factures (reference, base_fact, total_ht, total_tva, total_ttc_initial ,total_ttc, total_paye, reste,
			CLIENT, projet, ref_bc, iddevis, idbl, date_facture, creusr, credat) 
SELECT CONCAT('GT-FCT-',(IF(ref<=9,CONCAT('000',ref),IF(ref>9 AND ref<=99,CONCAT('00',ref),IF(ref>99 AND ref<=999,CONCAT('0',ref),ref)))))
,'B', totalht , totaltva , totalttc , totalttc , 0, totalttc , c.denomination, d.projet, d.ref_bc,
...
UPDATE produits p SET  etat= IF((SELECT qte_act FROM qte_actuel q WHERE q.id_produit=p.id)> p.stock_min , 1,
			 ...
			 IF((SELECT qte_act FROM qte_actuel q WHERE q.id_produit = p.id)< p.stock_min, 3,
			 etat
			   )
			   )
...
CREATE TABLE IF NOT EXISTS `archive` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table Archives' AUTO_INCREMENT=602 ;
...
(591, './upload//devis/mois_05_2018/67/67_GT_DEV-0014_2018.pdf', 'Devis 67 #GT_DEV-0014/2018', 'devis', 'devis', 67, 1, 'Document', 1, '2018-05-07 00:18:16'),
(592, './upload/contrats05_2018/contrats_74.pdf', 'contrats 74', 'contrats', 'contrats', 74, 1, 'Document', 1, '2018-05-12 21:05:45'),
(593, './upload/contrats05_2018/contrats_100.pdf', 'contrats 100', 'contrats', 'contrats', 100, 1, 'Document', 1, '2018-05-12 21:11:22'),
(594, './upload/contrats05_2018/contrats_75.pdf', 'contrats 75', 'contrats', 'contrats', 75, 1, 'Document', 1, '2018-05-14 18:34:33'),
(595, './upload//devis/mois_05_2018/68/68_GT_DEV-0015_2018.pdf', 'Devis 68 #GT_DEV-0015/2018', 'devis', 'devis', 68, 1, 'Document', 1, '2018-05-14 18:55:54'),
(596, './upload//devis/mois_05_2018/69/69_GT_DEV-0016_2018.pdf', 'Devis 69 #GT_DEV-0016/2018', 'devis', 'devis', 69, 1, 'Document', 1, '2018-05-15 19:58:11'),
(597, './upload//devis/mois_05_2018/70/70_GT_DEV-0017_2018.pdf', 'Devis 70 #GT_DEV-0017/2018', 'devis', 'devis', 70, 1, 'Document', 1, '2018-05-16 17:14:15'),
(598, './upload//devis/mois_05_2018/71/71_GT_DEV-0018_2018.pdf', 'Devis 71 #GT_DEV-0018/2018', 'devis', 'devis', 71, 1, 'Document', 1, '2018-05-17 15:27:58'),
(599, './upload//devis/mois_05_2018/72/72_GT_DEV-0019_2018.pdf', 'Devis 72 #GT_DEV-0019/2018', 'devis', 'devis', 72, 1, 'Document', 1, '2018-05-19 12:10:08'),
(600, './upload//devis/mois_05_2018/73/73_GT_DEV-0020_2018.pdf', 'Devis 73 #GT_DEV-0020/2018', 'devis', 'devis', 73, 1, 'Document', 1, '2018-05-19 12:35:29'),
(601, './upload//devis/mois_05_2018/74/74_GT_DEV-0021_2018.pdf', 'Devis 74 #GT_DEV-0021/2018', 'devis', 'devis', 74, 1, 'Document', 1, '2018-05-19 12:45:39');
...
(13, 'GT_BL-0001/2018', 'DCT', 'PROJET de test', 'ok ', 70, '2018-05-16', 0, 1, '2018-05-16 17:42:53', NULL, NULL),
(14, 'GT_BL-0002/2018', 'DCT', 'Projet', 'ok', 71, '2018-05-17', 1, 1, '2018-05-17 15:36:05', 1, '2018-05-17 17:36:32'),
(15, 'GT_BL-0003/2018', 'GSI', 'projet de test', 'OKKK', 72, '2018-05-19', 1, 1, '2018-05-19 12:12:12', 1, '2018-05-19 14:16:32'),
(17, 'GT_BL-0004/2018', 'DCT', 'test', 'okk', 73, '2018-05-19', 1, 1, '2018-05-19 12:48:59', 1, '2018-05-19 14:50:14');
...
(74, '939ac00bd98ad97bd7eb4e01cd75c3c3', 'GT_CTR-0001/2018', 42, '2018-01-27', '2019-01-26', NULL, '2018-01-26', 4, 'D', '2018-01-27', NULL, NULL, 592, 4, 1, '2018-01-26 23:35:33', 1, '2018-05-12 22:05:44'),
(75, '4ede9e9b5e57dc083d446a3db208638e', 'GT_CTR-0002/2018', 55, '2018-02-25', '2020-02-24', NULL, '2018-02-24', 1, 'D', '2019-02-14', NULL, NULL, 594, 4, 1, '2018-02-04 18:40:50', 1, '2018-05-14 20:34:32'),
...
(100, 'd9601d32f390d0e719a14541e8bd2121', 'GT_CTR-0008/2018', 66, '2018-04-29', '2018-05-28', NULL, '2018-04-29', 4, 'D', '2018-05-05', NULL, NULL, 593, 4, 1, '2018-04-29 13:12:39', 1, '2018-05-12 22:11:21'),
...
(103, 'bdafe75a9abb263c506f0d8dedefe5f8', 'GT_CTR-0010/2018', 42, '2018-05-12', '2018-07-11', NULL, '2018-05-12', 6, 'D', '2018-05-18', NULL, NULL, NULL, 0, 1, '2018-05-12 22:05:44', NULL, NULL),
(104, '82aee007755ee5506cd7646b87f15f1b', 'GT_CTR-0011/2018', 66, '2018-05-12', '2019-01-11', NULL, '2018-05-12', 6, 'D', '2018-06-01', NULL, NULL, NULL, 0, 1, '2018-05-12 22:11:21', NULL, NULL),
(105, 'bcf4f17a193908fe05ec834eb0d38a24', 'GT_CTR-0012/2018', 55, '2018-06-01', '2018-08-31', NULL, '2018-05-14', 6, 'D', '2018-06-22', NULL, NULL, NULL, 0, 1, '2018-05-14 20:34:32', NULL, NULL);
...
(64, 'a4976bbfe00197cc59ed9bd583850ff7', 'ABN', 'GT_DEV-0011/2018', 'hhhh', 24, 'O', 2, 0, 0, '2018-04-06', 'P', 0, 0, 150000, 177000, 27000, 30, '<p>Paiement 100% à la commande</p><p>Test saisi<br></p>', 'OK', NULL, 585, 4, 1, '2018-04-06 21:58:36', NULL, NULL),
...
(67, '7d4bb3fee2b901b74c029d9ec7a9a66c', 'VNT', 'GT_DEV-0014/2018', 'Te', 27, 'O', 2, 0, 0, '2018-05-07', 'P', 0, 0, 750000, 885000, 135000, 30, 'Paiement 100% à la commande', 'bn cmd', NULL, 591, 4, 1, '2018-05-07 01:18:03', NULL, NULL),
(68, '211e6dc61515a86b672f933bb0adc20c', 'VNT', 'GT_DEV-0015/2018', 'PROJ', 27, 'O', 2, 0, 0, '2018-05-14', 'P', 0, 0, 1270000, 1498600, 228600, 90, 'Paiement 100% à la commande', 'bv', NULL, 595, 4, 1, '2018-05-14 20:52:42', NULL, NULL),
(69, '78f530127a8e9e32a902a14fe7846558', 'VNT', 'GT_DEV-0016/2018', 'Test 15', 26, 'O', 1, 0, 0, '2018-05-15', 'P', 0, 0, 17250000, 20355000, 3105000, 180, 'Paiement 100% à la commande', 'ref test', NULL, 596, 4, 1, '2018-05-15 21:57:22', NULL, NULL),
(70, '8c90b9914b0085135a36b2b10a4032e2', 'VNT', 'GT_DEV-0017/2018', 'PROJET de test', 27, 'N', 2, 10, 2816000, '2018-05-16', 'P', 0, 0, 28160000, 28160000, 0, 180, 'Paiement 100% à la commande', 'ok ', NULL, 597, 8, 1, '2018-05-16 19:12:55', NULL, NULL),
(71, '003c8b56e2a2fc9bde2788593e4607b6', 'VNT', 'GT_DEV-0018/2018', 'Projet', 27, 'O', 1, 0, 0, '2018-05-17', 'P', 0, 0, 10650000, 12567000, 1917000, 30, 'Paiement 100% à la commande', 'ok', NULL, 598, 8, 1, '2018-05-17 17:25:46', NULL, NULL),
(72, '534616df9bdc4c27b045dccd11aa5d9f', 'VNT', 'GT_DEV-0019/2018', 'projet de test', 26, 'O', 2, 10, 973500, '2018-05-19', 'P', 0, 0, 8250000, 9735000, 1485000, 180, 'Paiement 100% à la commande', 'OKKK', NULL, 599, 8, 1, '2018-05-19 14:09:55', NULL, NULL),
(73, 'b130673172fa4f998e3dfaa532145492', 'VNT', 'GT_DEV-0020/2018', 'test', 27, 'O', 2, 10, 1362900, '2018-05-19', 'P', 0, 0, 11550000, 13629000, 2079000, 30, 'Paiement 100% à la commande', 'okk', NULL, 600, 8, 1, '2018-05-19 14:34:10', NULL, NULL),
(74, 'd86d8dcc052779b2f3bb30b6db71e53c', 'VNT', 'GT_DEV-0021/2018', 'test kada', 27, 'O', 2, 0, 0, '2018-05-19', 'P', 0, 0, 2400000000, 2832000000, 432000000, 30, 'Paiement 100% à la commande', 'test', NULL, 601, 4, 1, '2018-05-19 14:45:23', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `d_bl` (
  ...
  `qte` int(11) DEFAULT NULL COMMENT 'la quantité livrée',
...
INSERT INTO `d_bl` (`id`, `order`, `id_bl`, `id_produit`, `ref_produit`, `designation`, `qte`, `creusr`, `credat`, `updusr`, `upddat`) VALUES
(18, 1, 13, 1, 'GT_PRD-0008', 'iDIRECT EVOLUTION X6', 0, '1', '2018-05-16 17:42:53', '1', '2018-05-19 11:31:56'),
(19, 2, 13, 24, 'GT-PRD-3/2017', 'Antenne VSAT 1.2m bande Ku Skyware Globa', 3, '1', '2018-05-16 17:42:53', '1', '2018-05-19 11:24:46'),
(20, 3, 13, 26, 'GT-PRD-5/2017', 'Installation Site', 0, '1', '2018-05-16 17:42:53', '1', '2018-05-19 11:24:46'),
(21, 2, 14, 1, 'GT_PRD-0008', 'iDIRECT EVOLUTION X6', 1, '1', '2018-05-17 15:36:05', NULL, NULL),
(22, 3, 14, 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 3, '1', '2018-05-17 15:36:05', NULL, NULL),
(23, 1, 14, 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 5, '1', '2018-05-17 15:36:05', NULL, NULL),
(24, 2, 15, 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 7, '1', '2018-05-19 12:12:12', '1', '2018-05-19 12:16:19'),
(25, 1, 15, 33, 'GT_PRD-0010', 'Modem de test', 5, '1', '2018-05-19 12:12:12', NULL, NULL),
(27, 2, 17, 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 10, '1', '2018-05-19 12:48:59', '1', '2018-05-19 12:50:08'),
(28, 1, 17, 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 10, '1', '2018-05-19 12:48:59', NULL, NULL);
...
(231, 1, 67, '7d4bb3fee2b901b74c029d9ec7a9a66c', 1, 'GT_PRD-0008', 'iDIRECT EVOLUTION X6', 1, 750000, 'P', 0, 0, 750000, NULL, 750000, 885000, 135000, '1', NULL, NULL, NULL),
(232, 1, 68, '211e6dc61515a86b672f933bb0adc20c', 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 10, 150000, 'P', 0, 18, 150000, NULL, 150000, 177000, 27000, '1', NULL, NULL, NULL),
(233, 2, 68, '211e6dc61515a86b672f933bb0adc20c', 23, 'GT-PRD-2/2017', 'Modem iDirect Evolution X3', 10, 1120000, 'P', 0, 18, 1120000, NULL, 1120000, 1321600, 201600, '1', NULL, NULL, NULL),
(234, 1, 69, '78f530127a8e9e32a902a14fe7846558', 24, 'GT-PRD-3/2017', 'Antenne VSAT 1.2m bande Ku Skyware Globa', 15, 700000, 'P', 0, 18, 700000, NULL, 10500000, 12390000, 1890000, '1', NULL, NULL, NULL),
(235, 2, 69, '78f530127a8e9e32a902a14fe7846558', 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 10, 750000, 'P', 10, 18, 675000, NULL, 6750000, 7965000, 1215000, '1', NULL, NULL, NULL),
(236, 1, 70, '8c90b9914b0085135a36b2b10a4032e2', 1, 'GT_PRD-0008', 'iDIRECT EVOLUTION X6', 20, 750000, 'P', 0, 18, 825000, NULL, 16500000, 16500000, 0, '1', NULL, NULL, NULL),
(237, 2, 70, '8c90b9914b0085135a36b2b10a4032e2', 24, 'GT-PRD-3/2017', 'Antenne VSAT 1.2m bande Ku Skyware Globa', 15, 700000, 'P', 0, 18, 770000, NULL, 11550000, 11550000, 0, '1', NULL, NULL, NULL),
(238, 3, 70, '8c90b9914b0085135a36b2b10a4032e2', 26, 'GT-PRD-5/2017', 'Installation Site', 2, 50000, 'P', 0, 18, 55000, NULL, 110000, 110000, 0, '1', NULL, NULL, NULL),
(239, 1, 71, '003c8b56e2a2fc9bde2788593e4607b6', 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 10, 750000, 'P', 0, 18, 750000, NULL, 7500000, 8850000, 1350000, '1', NULL, '1', '2018-05-17 15:22:43'),
(240, 2, 71, '003c8b56e2a2fc9bde2788593e4607b6', 1, 'GT_PRD-0008', 'iDIRECT EVOLUTION X6', 3, 750000, 'P', 0, 18, 750000, NULL, 2250000, 2655000, 405000, '1', NULL, NULL, NULL),
(241, 3, 71, '003c8b56e2a2fc9bde2788593e4607b6', 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 6, 150000, 'P', 0, 18, 150000, NULL, 900000, 1062000, 162000, '1', NULL, NULL, NULL),
(242, 1, 72, '534616df9bdc4c27b045dccd11aa5d9f', 33, 'GT_PRD-0010', 'Modem de test', 5, 1200000, 'P', 0, 18, 1320000, NULL, 6600000, 7788000, 1188000, '1', NULL, NULL, NULL),
(243, 2, 72, '534616df9bdc4c27b045dccd11aa5d9f', 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 10, 150000, 'P', 0, 18, 165000, NULL, 1650000, 1947000, 297000, '1', NULL, NULL, NULL),
(244, 1, 73, 'b130673172fa4f998e3dfaa532145492', 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 10, 750000, 'P', 0, 18, 825000, NULL, 8250000, 9735000, 1485000, '1', NULL, NULL, NULL),
(245, 2, 73, 'b130673172fa4f998e3dfaa532145492', 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 20, 150000, 'P', 0, 18, 165000, NULL, 3300000, 3894000, 594000, '1', NULL, NULL, NULL),
(246, 1, 74, 'd86d8dcc052779b2f3bb30b6db71e53c', 33, 'GT_PRD-0010', 'Modem de test', 2000, 1200000, 'P', 0, 18, 1200000, NULL, 2400000000, 2832000000, 432000000, '1', NULL, NULL, NULL);
...
(50, 1, 142, 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 5, ' ', 750000, 'P', 0, 0, 825000, NULL, 4125000, 4867500, 742500, '1', '2018-05-13 14:42:31', NULL, NULL),
(51, 2, 142, 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 10, ' ', 150000, 'P', 0, 0, 165000, NULL, 1650000, 1947000, 297000, '1', '2018-05-13 14:42:31', NULL, NULL),
(52, 3, 142, 24, 'GT-PRD-3/2017', 'Antenne VSAT 1.2m bande Ku Skyware Globa', 3, ' ', 700000, 'P', 0, 0, 770000, NULL, 2310000, 2725800, 415800, '1', '2018-05-13 14:42:31', NULL, NULL),
(63, 1, 153, 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 1, ' ', 150000, 'P', 0, 18, 150000, NULL, 150000, 177000, 27000, '1', '2018-05-14 21:50:24', NULL, NULL),
(64, 2, 153, 23, 'GT-PRD-2/2017', 'Modem iDirect Evolution X3', 1, ' ', 1120000, 'P', 0, 18, 1120000, NULL, 1120000, 1321600, 201600, '1', '2018-05-14 21:50:24', NULL, NULL),
(65, 1, 154, 24, 'GT-PRD-3/2017', 'Antenne VSAT 1.2m bande Ku Skyware Globa', 1, ' ', 700000, 'P', 0, 18, 700000, NULL, 700000, 826000, 126000, '1', '2018-05-15 20:05:35', NULL, NULL),
(66, 2, 154, 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 4, ' ', 750000, 'P', 10, 18, 675000, NULL, 2700000, 3186000, 486000, '1', '2018-05-15 20:05:35', NULL, NULL),
(67, 2, 155, 1, 'GT_PRD-0008', 'iDIRECT EVOLUTION X6', 1, ' ', 750000, 'P', 0, 18, 750000, NULL, 750000, 885000, 135000, '1', '2018-05-17 15:36:32', NULL, NULL),
(68, 3, 155, 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 3, ' ', 150000, 'P', 0, 18, 150000, NULL, 450000, 531000, 81000, '1', '2018-05-17 15:36:32', NULL, NULL),
(69, 1, 155, 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 5, ' ', 750000, 'P', 0, 18, 750000, NULL, 3750000, 4425000, 675000, '1', '2018-05-17 15:36:32', NULL, NULL),
(70, 2, 156, 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 7, ' ', 150000, 'P', 0, 18, 165000, NULL, 1155000, 1362900, 207900, '1', '2018-05-19 12:16:32', NULL, NULL),
(71, 1, 156, 33, 'GT_PRD-0010', 'Modem de test', 5, ' ', 1200000, 'P', 0, 18, 1320000, NULL, 6600000, 7788000, 1188000, '1', '2018-05-19 12:16:32', NULL, NULL),
(72, 2, 157, 22, 'GT-PRD-1/2017', 'LNB PLL bande C', 10, ' ', 150000, 'P', 0, 18, 165000, NULL, 1650000, 1947000, 297000, '1', '2018-05-19 12:50:14', NULL, NULL),
(73, 1, 157, 30, 'GT_PRD-0008', 'iDIRECT EVOLUTION X5', 10, ' ', 750000, 'P', 0, 18, 825000, NULL, 8250000, 9735000, 1485000, '1', '2018-05-19 12:50:14', NULL, NULL);
...
(141, NULL, NULL, '2018-05-12', 0, NULL, 103, '2018-05-12', '2018-07-11', 0, 1, '2018-05-12 22:05:45', NULL, NULL),
(142, NULL, NULL, '2018-05-12', 0, NULL, 104, '2018-05-12', '2018-07-11', 0, 1, '2018-05-12 22:11:22', NULL, NULL),
(143, NULL, NULL, '2018-07-12', 0, NULL, 104, '2018-07-12', '2018-09-11', 0, 1, '2018-05-12 22:11:22', NULL, NULL),
(144, NULL, NULL, '2018-09-12', 0, NULL, 104, '2018-09-12', '2018-11-11', 0, 1, '2018-05-12 22:11:22', NULL, NULL),
(145, NULL, NULL, '2018-11-12', 0, NULL, 104, '2018-11-12', '2019-01-11', 0, 1, '2018-05-12 22:11:22', NULL, NULL),
(146, NULL, NULL, '2018-06-01', 0, NULL, 105, '2018-06-01', '2018-06-30', 0, 1, '2018-05-14 20:34:33', NULL, NULL),
(147, NULL, NULL, '2018-08-01', 0, NULL, 105, '2018-08-01', '2018-08-31', 0, 1, '2018-05-14 20:34:33', NULL, NULL);
...
(1, 'GT_ENT-0001/2018', 'Entrepôt des vsat', 'bd charles de gaulee', '2018-02-01', 1, 1, '2018-04-25 19:05:30', 1, '2018-05-13 11:47:44'),
(2, 'GT_ENT-0002/2018', 'Test entrepot', 'bd charles de gaule 2466', '2018-05-14', 1, 1, '2018-05-19 11:45:12', 1, '2018-05-19 14:04:10');
...
(203, 'e4588f25307cbb881b9e85937ad870bf', 'bl', 3, 'etat', '0', '1', 'admin', '2018-05-07 00:21:41'),
(204, '28d2b7a5c5c9ba3df2b2c6c8548f8c44', 'bl', 3, 'etat', '0', '1', 'admin', '2018-05-07 00:23:54'),
(205, '42887e75b1598f95905d7061b9cceec6', 'bl', 2, 'etat', '0', '1', 'admin', '2018-05-08 22:28:18'),
(206, '4f998ee11f33cf29273fc8807fe5b2fc', 'entrepots', 1, 'etat', '1', '0', 'admin', '2018-05-13 09:45:42'),
(207, '009aaf3bf3b075e71bfaf2a400b2ffe7', 'entrepots', 1, 'emplacement', 'bd charles de gaule', 'bd charles de gaulee', 'admin', '2018-05-13 09:45:51'),
(208, '9a0fffd13890b8749f59420989681fd3', 'entrepots', 1, 'etat', '0', '1', 'admin', '2018-05-13 09:47:44'),
(209, '1546be28e93372fed3027e9fe9782a88', 'produits', 1, 'stock_min', '1', '2', 'admin', '2018-05-13 09:48:04'),
(210, 'fac02c8f2c24c5fc39731b85384420a7', 'bl', 2, 'etat', '0', '1', 'admin', '2018-05-13 19:53:53'),
(211, 'cda7689195f86547f804c888ea2712f8', 'bl', 8, 'etat', '0', '1', 'admin', '2018-05-13 20:41:40'),
(212, '8bbb29f30243eb361bc2b5b06427d385', 'bl', 8, 'etat', '0', '1', 'admin', '2018-05-13 20:45:59'),
(213, '6f40f3466a1225cb48ab1cc96389de32', 'bl', 8, 'etat', '0', '1', 'admin', '2018-05-13 20:47:57'),
(214, 'aac12727a5edb4aac6796b8c42e43178', 'bl', 8, 'etat', '0', '1', 'admin', '2018-05-14 17:33:20'),
(215, '112a1ce0c56b7c9f289af353183a574f', 'bl', 8, 'etat', '0', '1', 'admin', '2018-05-14 17:39:31'),
(216, 'c6ebca92b819ad94eca1ade759814795', 'bl', 8, 'etat', '0', '1', 'admin', '2018-05-14 17:51:43'),
(217, '09b97982362adb2c0a76014357a574ce', 'bl', 8, 'etat', '0', '1', 'admin', '2018-05-14 17:54:38'),
(218, '0a3a791ce64665dc118508ce862e1df5', 'bl', 9, 'etat', '0', '1', 'admin', '2018-05-14 21:50:24'),
(219, '199ad7e68d53f42ec7bb11715fef6515', 'bl', 11, 'etat', '0', '1', 'admin', '2018-05-15 20:05:35'),
(220, 'e84ac949ca7ca5d19b30f44a54ae9895', 'bl', 14, 'etat', '0', '1', 'admin', '2018-05-17 15:36:32'),
(221, 'ddf089c5f9aabdc183357e47527522d8', 'entrepots', 2, 'emplacement', 'bd charles de gaule 24', 'bd charles de gaule 2466', 'admin', '2018-05-19 12:04:01'),
(222, 'f721295d0c8ec924ea628c4f650a1a02', 'entrepots', 2, 'etat', '0', '1', 'admin', '2018-05-19 12:04:10'),
(223, '7641136f8bafebb94bd4c6e499703dce', 'bl', 15, 'etat', '0', '1', 'admin', '2018-05-19 12:16:32'),
(224, 'b29457ee165bee28040f805b0df40bbb', 'bl', 17, 'etat', '0', '1', 'admin', '2018-05-19 12:50:14');
...
(142, 'GT-FCT-0020/2018', 'B', 'P', 0, 8085000, 1455300, 9540300, 9540300, 0, 9540300, 'Test2018', NULL, 'OKK', 'O', NULL, NULL, 61, 2, '2018-05-13', NULL, NULL, 0, 1, '2018-05-13 14:42:31', NULL, NULL),
(153, 'GT-FCT-0021/2018', 'B', 'P', 0, 1270000, 228600, 1498600, 1498600, 0, 1498600, 'DCT', 'PROJ', 'Réf BC', 'O', NULL, NULL, 68, 9, '2018-05-14', NULL, NULL, 0, 1, '2018-05-14 21:50:24', NULL, NULL),
(154, 'GT-FCT-0022/2018', 'B', 'P', 0, 3400000, 612000, 4012000, 4012000, 0, 4012000, 'GSI', 'Test 15', 'ref test', 'O', NULL, NULL, 69, 11, '2018-05-15', NULL, NULL, 0, 1, '2018-05-15 20:05:35', NULL, NULL),
(155, 'GT-FCT-0023/2018', 'B', 'P', 0, 4950000, 891000, 5841000, 5841000, 0, 5841000, 'DCT', 'Projet', 'ok', 'O', NULL, NULL, 71, 14, '2018-05-17', NULL, NULL, 0, 1, '2018-05-17 15:36:32', NULL, NULL),
(156, 'GT-FCT-0024/2018', 'B', 'P', 0, 7755000, 1395900, 9150900, 9150900, 0, 9150900, 'GSI', 'projet de test', 'OKKK', 'O', NULL, NULL, 72, 15, '2018-05-19', NULL, NULL, 0, 1, '2018-05-19 12:16:32', NULL, NULL),
(157, 'GT-FCT-0025/2018', 'B', 'P', 0, 9900000, 1782000, 11682000, 11682000, 0, 11682000, 'DCT', 'test', 'okk', 'O', NULL, NULL, 73, 17, '2018-05-19', NULL, NULL, 0, 1, '2018-05-19 12:50:14', NULL, NULL);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table Systeme Modules' AUTO_INCREMENT=145 ;
...
(142, 'bl', 'Gestion BL', 'vente/submodul/bl', 'bl', 'bl', 'vente', 2, 0, '[-1-2-3-5-4-]'),
(143, 'stock_actuel', 'Stock Actuel', 'stock/submodul/stock_actuel', 'mouvements_stock', 'stock_actuel', 'stock', 2, 0, '[-1-2-3-5-]'),
(144, 'devis', 'Gestion Devis', 'vente/submodul/devis', 'devis', 'devis', 'vente', 2, 0, '[-1-2-3-]');

-- --------------------------------------------------------

--
-- Doublure de structure pour la vue `mouvements_stock`
--
CREATE TABLE IF NOT EXISTS `mouvements_stock` (
`id` int(11)
,`entrepot` varchar(200)
,`id_produit` int(11)
...
(1, 'GT_PRD-0008', 'iDIRECT EVOLUTION X6', 2, 1, 8, 6, 1, 750000, 3, 1, '2018-03-04 12:58:42', 1, '2018-05-19 16:06:10'),
(22, 'GT-PRD-1/2017', 'LNB PLL bande C', 1, 1, 9, 6, 1, 125000, 3, 19, '2017-10-11 10:47:16', 22, '2017-10-16 23:09:25'),
...
(32, 'GT_PRD-0009', 'test entrepot', 12, 1, 13, 5, 1, NULL, 3, 1, '2018-04-25 22:33:06', 1, '2018-04-25 22:33:37'),
(33, 'GT_PRD-0010', 'Modem de test', 10, 2, 8, 6, 1, 1200000, 1, 1, '2018-05-19 14:05:03', 1, '2018-05-19 14:05:22');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table store rules for each user for each App and action' AUTO_INCREMENT=46315 ;
...
(45322, 888, '0e79510db7f03b9b6266fc7b4a612153', 2, 2, 1459, 'Gestion Devis', 1, '1', '2018-05-15 19:53:04'),
(45323, 888, '0e79510db7f03b9b6266fc7b4a612153', 5, 19, 1459, 'Gestion Devis', 1, '1', '2018-05-15 19:53:04'),
(45324, 888, '0e79510db7f03b9b6266fc7b4a612153', 3, 20, 1459, 'Gestion Devis', 1, '1', '2018-05-15 19:53:04'),
(45325, 888, '0e79510db7f03b9b6266fc7b4a612153', 1, 22, 1459, 'Gestion Devis', 1, '1', '2018-05-15 19:53:04'),
(45326, 888, '0e79510db7f03b9b6266fc7b4a612153', 1, 23, 1459, 'Gestion Devis', 1, '1', '2018-05-15 19:53:04'),
(45327, 888, '0e79510db7f03b9b6266fc7b4a612153', 3, 24, 1459, 'Gestion Devis', 1, '1', '2018-05-15 19:53:04'),
(45329, 888, 'c15b00a1e37657336df8b6aa0eea2db5', 2, 2, 1460, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45330, 888, 'c15b00a1e37657336df8b6aa0eea2db5', 5, 19, 1460, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45331, 888, 'c15b00a1e37657336df8b6aa0eea2db5', 3, 20, 1460, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45332, 888, 'c15b00a1e37657336df8b6aa0eea2db5', 1, 22, 1460, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45333, 888, 'c15b00a1e37657336df8b6aa0eea2db5', 1, 23, 1460, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45334, 888, 'c15b00a1e37657336df8b6aa0eea2db5', 3, 24, 1460, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45335, 888, '7cfdba6bc6bc94c65b97e77746cf49b5', 2, 2, 1461, 'Envoi au client', 0, '1', '2018-05-15 19:53:04'),
(45336, 888, '7cfdba6bc6bc94c65b97e77746cf49b5', 5, 19, 1461, 'Envoi au client', 0, '1', '2018-05-15 19:53:04'),
(45337, 888, '7cfdba6bc6bc94c65b97e77746cf49b5', 1, 22, 1461, 'Envoi au client', 0, '1', '2018-05-15 19:53:04'),
(45338, 888, '7cfdba6bc6bc94c65b97e77746cf49b5', 1, 23, 1461, 'Envoi au client', 0, '1', '2018-05-15 19:53:04'),
(45340, 888, '28e267a2a0647d4cb37b18abb1e7d051', 2, 2, 1462, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45341, 888, '28e267a2a0647d4cb37b18abb1e7d051', 5, 19, 1462, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45342, 888, '28e267a2a0647d4cb37b18abb1e7d051', 3, 20, 1462, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45343, 888, '28e267a2a0647d4cb37b18abb1e7d051', 1, 22, 1462, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45344, 888, '28e267a2a0647d4cb37b18abb1e7d051', 1, 23, 1462, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45345, 888, '28e267a2a0647d4cb37b18abb1e7d051', 3, 24, 1462, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45347, 888, 'd34b07afd92adad84e1c4c2ebd92ba95', 2, 2, 1463, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45348, 888, 'd34b07afd92adad84e1c4c2ebd92ba95', 5, 19, 1463, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45349, 888, 'd34b07afd92adad84e1c4c2ebd92ba95', 3, 20, 1463, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45350, 888, 'd34b07afd92adad84e1c4c2ebd92ba95', 1, 22, 1463, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45351, 888, 'd34b07afd92adad84e1c4c2ebd92ba95', 1, 23, 1463, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45352, 888, 'd34b07afd92adad84e1c4c2ebd92ba95', 3, 24, 1463, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45354, 888, 'f6f55b9d0ba9d704b2861d57cda32477', 2, 2, 1464, 'Réponse Client', 0, '1', '2018-05-15 19:53:04'),
(45355, 888, 'f6f55b9d0ba9d704b2861d57cda32477', 5, 19, 1464, 'Réponse Client', 0, '1', '2018-05-15 19:53:04'),
(45356, 888, 'f6f55b9d0ba9d704b2861d57cda32477', 1, 22, 1464, 'Réponse Client', 0, '1', '2018-05-15 19:53:04'),
(45357, 888, 'f6f55b9d0ba9d704b2861d57cda32477', 1, 23, 1464, 'Réponse Client', 0, '1', '2018-05-15 19:53:04'),
(45358, 888, 'f6f55b9d0ba9d704b2861d57cda32477', 3, 24, 1464, 'Réponse Client', 0, '1', '2018-05-15 19:53:04'),
(45360, 888, '4b11c0bfb3f970a541100f7fc334927e', 2, 2, 1465, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45361, 888, '4b11c0bfb3f970a541100f7fc334927e', 5, 19, 1465, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45362, 888, '4b11c0bfb3f970a541100f7fc334927e', 3, 20, 1465, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45363, 888, '4b11c0bfb3f970a541100f7fc334927e', 1, 22, 1465, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45364, 888, '4b11c0bfb3f970a541100f7fc334927e', 1, 23, 1465, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45365, 888, '4b11c0bfb3f970a541100f7fc334927e', 3, 24, 1465, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45367, 888, '61a0655c2c13039b5b8262b82ae6cb51', 2, 2, 1466, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45368, 888, '61a0655c2c13039b5b8262b82ae6cb51', 5, 19, 1466, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45369, 888, '61a0655c2c13039b5b8262b82ae6cb51', 3, 20, 1466, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45370, 888, '61a0655c2c13039b5b8262b82ae6cb51', 1, 22, 1466, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45371, 888, '61a0655c2c13039b5b8262b82ae6cb51', 1, 23, 1466, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45372, 888, '61a0655c2c13039b5b8262b82ae6cb51', 3, 24, 1466, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45374, 888, 'ed30dfbb21d8d24a0da432252358bdf8', 2, 2, 1467, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45375, 888, 'ed30dfbb21d8d24a0da432252358bdf8', 5, 19, 1467, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45376, 888, 'ed30dfbb21d8d24a0da432252358bdf8', 3, 20, 1467, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45377, 888, 'ed30dfbb21d8d24a0da432252358bdf8', 1, 22, 1467, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45378, 888, 'ed30dfbb21d8d24a0da432252358bdf8', 1, 23, 1467, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45379, 888, 'ed30dfbb21d8d24a0da432252358bdf8', 3, 24, 1467, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45381, 888, '7bd2e025ffb3893dea4776e152301716', 5, 19, 1468, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45382, 888, '7bd2e025ffb3893dea4776e152301716', 1, 22, 1468, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45383, 888, '7bd2e025ffb3893dea4776e152301716', 1, 23, 1468, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45384, 888, '7bd2e025ffb3893dea4776e152301716', 3, 24, 1468, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45386, 888, '6d9ec7d9ebebcdc921376e7bf0c9fdaf', 5, 19, 1469, 'Valider devis', 0, '1', '2018-05-15 19:53:04'),
(45387, 888, '6d9ec7d9ebebcdc921376e7bf0c9fdaf', 1, 22, 1469, 'Valider devis', 0, '1', '2018-05-15 19:53:04'),
(45388, 888, '6d9ec7d9ebebcdc921376e7bf0c9fdaf', 1, 23, 1469, 'Valider devis', 0, '1', '2018-05-15 19:53:04'),
(45389, 888, '6d9ec7d9ebebcdc921376e7bf0c9fdaf', 3, 24, 1469, 'Valider devis', 0, '1', '2018-05-15 19:53:04'),
(45391, 888, 'b1bcc4a4ab154f110abcf54c0c659fb3', 2, 2, 1470, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45392, 888, 'b1bcc4a4ab154f110abcf54c0c659fb3', 5, 19, 1470, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45393, 888, 'b1bcc4a4ab154f110abcf54c0c659fb3', 1, 22, 1470, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45394, 888, 'b1bcc4a4ab154f110abcf54c0c659fb3', 1, 23, 1470, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45395, 888, 'b1bcc4a4ab154f110abcf54c0c659fb3', 3, 24, 1470, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45397, 888, '91a90a46e3430c491ab8db654b6e87c4', 2, 2, 1471, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45398, 888, '91a90a46e3430c491ab8db654b6e87c4', 5, 19, 1471, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45399, 888, '91a90a46e3430c491ab8db654b6e87c4', 1, 22, 1471, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45400, 888, '91a90a46e3430c491ab8db654b6e87c4', 1, 23, 1471, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45401, 888, '91a90a46e3430c491ab8db654b6e87c4', 3, 24, 1471, 'Voir détails', 0, '1', '2018-05-15 19:53:04'),
(45403, 889, 'd9eeb330625c1b87e0df00986a47be01', 2, 2, 1475, 'Ajouter Devis', 0, '1', '2018-05-15 19:53:04'),
(45404, 889, 'd9eeb330625c1b87e0df00986a47be01', 5, 19, 1475, 'Ajouter Devis', 0, '1', '2018-05-15 19:53:04'),
(45405, 889, 'd9eeb330625c1b87e0df00986a47be01', 3, 20, 1475, 'Ajouter Devis', 0, '1', '2018-05-15 19:53:04'),
(45406, 889, 'd9eeb330625c1b87e0df00986a47be01', 1, 22, 1475, 'Ajouter Devis', 0, '1', '2018-05-15 19:53:04'),
(45407, 889, 'd9eeb330625c1b87e0df00986a47be01', 1, 23, 1475, 'Ajouter Devis', 0, '1', '2018-05-15 19:53:04'),
(45408, 889, 'd9eeb330625c1b87e0df00986a47be01', 3, 24, 1475, 'Ajouter Devis', 0, '1', '2018-05-15 19:53:04'),
(45410, 890, 'da93cdb05137e15aed9c4c18bddd746a', 2, 2, 1476, 'Ajouter détail devis', 0, '1', '2018-05-15 19:53:04'),
(45411, 890, 'da93cdb05137e15aed9c4c18bddd746a', 5, 19, 1476, 'Ajouter détail devis', 0, '1', '2018-05-15 19:53:04'),
(45412, 890, 'da93cdb05137e15aed9c4c18bddd746a', 3, 20, 1476, 'Ajouter détail devis', 0, '1', '2018-05-15 19:53:04'),
(45413, 890, 'da93cdb05137e15aed9c4c18bddd746a', 1, 22, 1476, 'Ajouter détail devis', 0, '1', '2018-05-15 19:53:04'),
(45414, 890, 'da93cdb05137e15aed9c4c18bddd746a', 1, 23, 1476, 'Ajouter détail devis', 0, '1', '2018-05-15 19:53:04'),
(45415, 890, 'da93cdb05137e15aed9c4c18bddd746a', 3, 24, 1476, 'Ajouter détail devis', 0, '1', '2018-05-15 19:53:04'),
(45417, 891, 'f9f3c299f9bd0fec014f6bd3f0e06adb', 2, 2, 1477, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45418, 891, 'f9f3c299f9bd0fec014f6bd3f0e06adb', 5, 19, 1477, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45419, 891, 'f9f3c299f9bd0fec014f6bd3f0e06adb', 3, 20, 1477, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45420, 891, 'f9f3c299f9bd0fec014f6bd3f0e06adb', 1, 22, 1477, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45421, 891, 'f9f3c299f9bd0fec014f6bd3f0e06adb', 1, 23, 1477, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45422, 891, 'f9f3c299f9bd0fec014f6bd3f0e06adb', 3, 24, 1477, 'Modifier Devis', 0, '1', '2018-05-15 19:53:04'),
(45424, 892, 'e14cce6f1faf7784adb327581c516b90', 5, 19, 1478, 'Supprimer Devis', 0, '1', '2018-05-15 19:53:04'),
(45425, 892, 'e14cce6f1faf7784adb327581c516b90', 3, 20, 1478, 'Supprimer Devis', 0, '1', '2018-05-15 19:53:04'),
(45426, 892, 'e14cce6f1faf7784adb327581c516b90', 1, 22, 1478, 'Supprimer Devis', 0, '1', '2018-05-15 19:53:04'),
(45427, 892, 'e14cce6f1faf7784adb327581c516b90', 1, 23, 1478, 'Supprimer Devis', 0, '1', '2018-05-15 19:53:04'),
(45428, 892, 'e14cce6f1faf7784adb327581c516b90', 3, 24, 1478, 'Supprimer Devis', 0, '1', '2018-05-15 19:53:04'),
(45430, 893, '38f10871792c133ebcc6040e9a11cde8', 2, 2, 1479, 'Modifier détail Devis', 0, '1', '2018-05-15 19:53:04'),
(45431, 893, '38f10871792c133ebcc6040e9a11cde8', 5, 19, 1479, 'Modifier détail Devis', 0, '1', '2018-05-15 19:53:04'),
(45432, 893, '38f10871792c133ebcc6040e9a11cde8', 3, 20, 1479, 'Modifier détail Devis', 0, '1', '2018-05-15 19:53:04'),
(45433, 893, '38f10871792c133ebcc6040e9a11cde8', 1, 22, 1479, 'Modifier détail Devis', 0, '1', '2018-05-15 19:53:04'),
(45434, 893, '38f10871792c133ebcc6040e9a11cde8', 1, 23, 1479, 'Modifier détail Devis', 0, '1', '2018-05-15 19:53:04'),
(45435, 893, '38f10871792c133ebcc6040e9a11cde8', 3, 24, 1479, 'Modifier détail Devis', 0, '1', '2018-05-15 19:53:04'),
(45437, 894, '8def42e75fd4aee61c378d9fb303850d', 2, 2, 1480, 'Afficher détail devis', 0, '1', '2018-05-15 19:53:04'),
(45438, 894, '8def42e75fd4aee61c378d9fb303850d', 5, 19, 1480, 'Afficher détail devis', 0, '1', '2018-05-15 19:53:04'),
(45439, 894, '8def42e75fd4aee61c378d9fb303850d', 3, 20, 1480, 'Afficher détail devis', 0, '1', '2018-05-15 19:53:04'),
(45440, 894, '8def42e75fd4aee61c378d9fb303850d', 1, 22, 1480, 'Afficher détail devis', 0, '1', '2018-05-15 19:53:04'),
(45441, 894, '8def42e75fd4aee61c378d9fb303850d', 1, 23, 1480, 'Afficher détail devis', 0, '1', '2018-05-15 19:53:04'),
(45442, 894, '8def42e75fd4aee61c378d9fb303850d', 3, 24, 1480, 'Afficher détail devis', 0, '1', '2018-05-15 19:53:04'),
(45444, 895, '7666e87783b0f5a7eec1eea7593f7dfe', 2, 2, 1481, 'Valider Devis', 0, '1', '2018-05-15 19:53:04'),
(45445, 895, '7666e87783b0f5a7eec1eea7593f7dfe', 5, 19, 1481, 'Valider Devis', 0, '1', '2018-05-15 19:53:04'),
(45446, 895, '7666e87783b0f5a7eec1eea7593f7dfe', 3, 20, 1481, 'Valider Devis', 0, '1', '2018-05-15 19:53:04'),
(45447, 895, '7666e87783b0f5a7eec1eea7593f7dfe', 1, 22, 1481, 'Valider Devis', 0, '1', '2018-05-15 19:53:04'),
(45448, 895, '7666e87783b0f5a7eec1eea7593f7dfe', 1, 23, 1481, 'Valider Devis', 0, '1', '2018-05-15 19:53:04'),
(45449, 895, '7666e87783b0f5a7eec1eea7593f7dfe', 3, 24, 1481, 'Valider Devis', 0, '1', '2018-05-15 19:53:04'),
(45451, 896, '7f1c48324d8c369da9aa6ab8af35acd8', 2, 2, 1482, 'Validation Client Devis', 0, '1', '2018-05-15 19:53:04'),
(45452, 896, '7f1c48324d8c369da9aa6ab8af35acd8', 5, 19, 1482, 'Validation Client Devis', 0, '1', '2018-05-15 19:53:04'),
(45453, 896, '7f1c48324d8c369da9aa6ab8af35acd8', 3, 20, 1482, 'Validation Client Devis', 0, '1', '2018-05-15 19:53:04'),
(45454, 896, '7f1c48324d8c369da9aa6ab8af35acd8', 1, 22, 1482, 'Validation Client Devis', 0, '1', '2018-05-15 19:53:04'),
(45455, 896, '7f1c48324d8c369da9aa6ab8af35acd8', 1, 23, 1482, 'Validation Client Devis', 0, '1', '2018-05-15 19:53:04'),
(45456, 896, '7f1c48324d8c369da9aa6ab8af35acd8', 3, 24, 1482, 'Validation Client Devis', 0, '1', '2018-05-15 19:53:04'),
(45458, 897, '6adf896091dde0df89f777f31606953c', 5, 19, 1483, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45459, 897, '6adf896091dde0df89f777f31606953c', 3, 20, 1483, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45460, 897, '6adf896091dde0df89f777f31606953c', 1, 22, 1483, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45461, 897, '6adf896091dde0df89f777f31606953c', 1, 23, 1483, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45462, 897, '6adf896091dde0df89f777f31606953c', 3, 24, 1483, 'Débloquer devis', 0, '1', '2018-05-15 19:53:04'),
(45464, 898, '15cbb79dd4a74266158e6b29a83e683c', 5, 19, 1484, 'Archiver Devis', 1, '1', '2018-05-15 19:53:04'),
(45465, 898, '15cbb79dd4a74266158e6b29a83e683c', 1, 22, 1484, 'Archiver Devis', 1, '1', '2018-05-15 19:53:04'),
(45466, 898, '15cbb79dd4a74266158e6b29a83e683c', 1, 23, 1484, 'Archiver Devis', 1, '1', '2018-05-15 19:53:04'),
(45467, 898, '15cbb79dd4a74266158e6b29a83e683c', 3, 24, 1484, 'Archiver Devis', 1, '1', '2018-05-15 19:53:04'),
(45945, 879, '29d3ba7d2ceccd9ee362a8c546946cad', 1, 1, 1442, 'Gestion BL', 1, '1', '2018-05-20 19:19:14'),
(45946, 879, 'aa39ac5e6ba2805784c71acf92030e0f', 1, 1, 1443, 'Valider BL', 0, '1', '2018-05-20 19:19:14'),
(45947, 879, 'a0e04a27854b1fc0587dbb818f9264d9', 1, 1, 1444, 'Détails BL     ', 0, '1', '2018-05-20 19:19:14'),
(45948, 879, 'cbc30164dd9987eabab0deca93fa13ae', 1, 1, 1447, 'Détails BL', 0, '1', '2018-05-20 19:19:14'),
(45949, 879, '02aebc37c7e38faea780fc8c11ee7fdc', 1, 1, 1458, 'Editer BL', 0, '1', '2018-05-20 19:19:14'),
(45950, 880, '0a8c8609ecb28b5ccbce6d7910d791fc', 1, 1, 1445, 'Valider BL', 1, '1', '2018-05-20 19:19:14'),
(45951, 881, 'cc8d69937778bdaa2240c40a229571ba', 1, 1, 1446, 'Détail BL', 1, '1', '2018-05-20 19:19:14'),
(45952, 887, 'b50607b922c3082698c6e5c388a1b2e2', 1, 1, 1457, 'Editer BL', 1, '1', '2018-05-20 19:19:14'),
(45953, 455, 'e69f84a801ee1525f20f34e684688a9b', 1, 1, 652, 'Gestion des catégories de produits', 0, '1', '2018-05-20 19:19:14'),
(45954, 455, '90f6eba3e0ed223e73d250278cb445d5', 1, 1, 653, 'Modifier catégorie', 0, '1', '2018-05-20 19:19:14'),
(45955, 455, 'c62968a45ae9cfa8b127ac1b5573988a', 1, 1, 654, 'Valider catégorie', 0, '1', '2018-05-20 19:19:14'),
(45956, 455, '6f43a6bcbd293f958aff51953559104e', 1, 1, 655, 'Désactiver catégorie', 0, '1', '2018-05-20 19:19:14'),
(45957, 456, 'd26f5940e88a494c0eb65047aab9a17b', 1, 1, 656, 'Ajouter une catégorie', 0, '1', '2018-05-20 19:19:14'),
(45958, 457, '27957c6d0f6869d4d90287cd50b6dde9', 1, 1, 657, 'Modifier une catégorie', 0, '1', '2018-05-20 19:19:14'),
(45959, 458, '41b48dd567e4f79e35261a47b7bad751', 1, 1, 658, 'Valider une catégorie', 0, '1', '2018-05-20 19:19:14'),
(45960, 459, '90dc20c4d1ad7be7fac8ec34d5ac26b3', 1, 1, 659, 'Supprimer une catégorie', 0, '1', '2018-05-20 19:19:14'),
(45961, 333, '6edc543080c65eca3993445c295ff94b', 1, 1, 497, 'Gestion Catégorie Client', 0, '1', '2018-05-20 19:19:14'),
(45962, 333, '142a68a109abd0462ea44fcadffe56de', 1, 1, 506, 'Editer Catégorie Client', 0, '1', '2018-05-20 19:19:14'),
(45963, 333, '70df89fa2654d8b10d7fc7e75e178b7e', 1, 1, 507, 'Activer Catégorie Client', 0, '1', '2018-05-20 19:19:14'),
(45964, 333, '109e82d6db5721f63cd827e9fd224216', 1, 1, 508, 'Désactiver Catégorie Client', 0, '1', '2018-05-20 19:19:14'),
(45965, 334, 'a5c1bd0dfd87824ff0f57c6b1e1d2c3f', 1, 1, 498, 'Ajouter Catégorie Client', 1, '1', '2018-05-20 19:19:14'),
(45966, 335, '8d901f74dfd6ee3a8f44ebd0b83fbfae', 1, 1, 499, 'Editer Catégorie Client', 1, '1', '2018-05-20 19:19:14'),
(45967, 336, 'e87327563ce6b659780d6b2c9bf8ac77', 1, 1, 500, 'Supprimer Catégorie Client', 1, '1', '2018-05-20 19:19:14'),
(45968, 337, 'c955da8d244aac06ee7595d08de7d009', 1, 1, 501, 'Valider Catégorie Client', 1, '1', '2018-05-20 19:19:14'),
(45969, 394, 'f12fb1c50aedc49c3fa3dfa2bd297bd3', 1, 1, 553, 'Gestion Clients', 0, '1', '2018-05-20 19:19:14'),
(45970, 394, 'dd3d5980299911ea854af4fa6f2e7309', 1, 1, 554, 'Editer Client', 0, '1', '2018-05-20 19:19:14'),
(45971, 394, '3c5c04a20d49ad010557a64c8cdac1ce', 1, 1, 555, 'Valider Client', 0, '1', '2018-05-20 19:19:14'),
(45972, 394, '18ace52052f2551099ecaabf049ffaec', 1, 1, 556, 'Désactiver Client', 0, '1', '2018-05-20 19:19:14'),
(45973, 394, '493f9e55fc0340763e07514c1900685a', 1, 1, 557, 'Détails Client', 0, '1', '2018-05-20 19:19:14'),
(45974, 394, '03b4f949b088e41fc9a1f3f23b7906a8', 1, 1, 558, 'Détails  Client', 0, '1', '2018-05-20 19:19:14'),
(45975, 395, '2b9d8bb8f752d1c35fb681c33e38b42b', 1, 1, 559, 'Ajouter Client', 1, '1', '2018-05-20 19:19:14'),
(45976, 396, '54aa9121e05f5e698d354022a8eab71d', 1, 1, 560, 'Editer Client', 1, '1', '2018-05-20 19:19:14'),
(45977, 397, '4eaf650e8c2221d590fac5a6a6952231', 1, 1, 561, 'Supprimer Client', 1, '1', '2018-05-20 19:19:14'),
(45978, 398, '534cd4b17fb8a371d3a20565ab8fd96e', 1, 1, 562, 'Valider Client', 1, '1', '2018-05-20 19:19:14'),
(45979, 399, '95bb6aa696ef630a335aa84e1e425e2c', 1, 1, 563, 'Détails Client', 0, '1', '2018-05-20 19:19:14'),
(45980, 752, '179906c1666d7e9a7b4d1f52a1f84ec0', 1, 1, 1200, 'Commerciale', 1, '1', '2018-05-20 19:19:14'),
(45981, 752, '3e2b9ccbb5837f42342934bd9ba3aa49', 1, 1, 1201, 'Modifier Commerciale', 0, '1', '2018-05-20 19:19:14'),
(45982, 752, '1f4be058271867b2a398678fb0e49750', 1, 1, 1202, 'Valider commerciale', 0, '1', '2018-05-20 19:19:14'),
(45983, 752, '3980ecadef51319f03ae82b686e97dc4', 1, 1, 1203, 'Détails commerciale', 0, '1', '2018-05-20 19:19:14'),
(45984, 752, 'b0abfcf29eaacb4bad1a88a663331182', 1, 1, 1204, 'Détails Commerciale', 0, '1', '2018-05-20 19:19:14'),
(45985, 752, '923af4f85ccb0b69f7920e557ed03768', 1, 1, 1205, 'Désactiver commerciale', 0, '1', '2018-05-20 19:19:14'),
(45986, 752, 'f2e2a34f24f845f58e3af9e1baf3d34c', 1, 1, 1206, 'Commissions', 0, '1', '2018-05-20 19:19:14'),
(45987, 753, '03b0a2e252d4c53940ca1817d9083f0a', 1, 1, 1207, 'Ajouter commerciale', 1, '1', '2018-05-20 19:19:14'),
(45988, 754, 'ab2d80f7396b53342b8455293be7c892', 1, 1, 1208, 'Modifier Commerciale', 1, '1', '2018-05-20 19:19:14'),
(45989, 755, 'b9de9130d6ec79fa1981fd935590d9c7', 1, 1, 1209, 'Valider commerciale', 1, '1', '2018-05-20 19:19:14'),
(45990, 756, '97f27dfbac6c8d8f785585ca54b1b8d4', 1, 1, 1210, 'Supprimer commerciale', 1, '1', '2018-05-20 19:19:14'),
(45991, 757, '250db5ee83c4c30061b983a26fb91ba9', 1, 1, 1211, 'Détails commerciale', 1, '1', '2018-05-20 19:19:14'),
(45992, 758, '738a72cd47c2630b73be1a92f8117525', 1, 1, 1212, 'Commissions', 1, '1', '2018-05-20 19:19:14'),
(45993, 758, '98f53da207662a231a3ff2377af1f03b', 1, 1, 1213, 'Payer Commission   ', 0, '1', '2018-05-20 19:19:14'),
(45994, 758, 'a51a876db71f5da2d9ef1ac6e4929543', 1, 1, 1214, 'Payer Commission', 0, '1', '2018-05-20 19:19:14'),
(45995, 758, 'd4327189d68e6aae34e614fbd5ecc9b8', 1, 1, 1215, 'Modifier commission', 0, '1', '2018-05-20 19:19:14'),
(45996, 758, '31cb75b08edc1219b940b8d9c3f74dec', 1, 1, 1216, 'Valider Commission', 0, '1', '2018-05-20 19:19:14'),
(45997, 758, '7b78301b1dfe281483854f0e23102bb1', 1, 1, 1217, 'Détails commission', 0, '1', '2018-05-20 19:19:15'),
(45998, 758, '9d48b04e7eb927ba243a8a52eed24d66', 1, 1, 1218, 'Détails commission', 0, '1', '2018-05-20 19:19:15'),
(45999, 758, 'f9ecac816e2e67543667014a6e2bd01b', 1, 1, 1219, 'Détails commission', 0, '1', '2018-05-20 19:19:15'),
(46000, 758, 'a824d5f254bea8798c2c719fba1d4f3b', 1, 1, 1220, 'Détails commission', 0, '1', '2018-05-20 19:19:15'),
(46001, 759, '5adc1562f2a8f48f30492133e6d82d48', 1, 1, 1221, 'Payer Commission', 1, '1', '2018-05-20 19:19:15'),
(46002, 760, 'd374ca19122a0b3f66f67bdbf74efc60', 1, 1, 1222, 'Ajouter commission', 1, '1', '2018-05-20 19:19:15'),
(46003, 761, '25bbc454f35643c1af3371fd02cc9195', 1, 1, 1223, 'Modifier commission', 1, '1', '2018-05-20 19:19:15'),
(46004, 762, 'c35c2ca29c5083910a20996ccd465a48', 1, 1, 1224, 'Valider Commission', 1, '1', '2018-05-20 19:19:15'),
(46005, 763, '418e3a3591fc54086c56b385077bfb71', 1, 1, 1225, 'Détails commission', 1, '1', '2018-05-20 19:19:15'),
(46006, 768, '899d40c8f22d4f7a6f048366f1829787', 1, 1, 1237, 'Gestion des contrats', 0, '1', '2018-05-20 19:19:15'),
(46007, 768, '4aea0d5a7bdb0e2513897507947fc3de', 1, 1, 1238, 'Modifier  contrat', 0, '1', '2018-05-20 19:19:15'),
(46008, 768, '4ccf7c3c72dfa25157ab01762069929e', 1, 1, 1239, 'Détail  contrat', 0, '1', '2018-05-20 19:19:15'),
(46009, 768, '18c5260f189a488c59134c1d53270dae', 1, 1, 1240, 'Valider  contrat', 0, '1', '2018-05-20 19:19:15'),
(46010, 768, '6ca83d9c6c0b229446da30b60b74031a', 1, 1, 1241, 'Détails  Contrat', 0, '1', '2018-05-20 19:19:15'),
(46011, 768, '52eef475bfa2afb7eb065329a93b0b4c', 1, 1, 1242, 'Renouveler  Contrat', 0, '1', '2018-05-20 19:19:15'),
(46012, 768, 'b23939959d533fa68091fca749b691aa', 1, 1, 1243, 'Détails Contrat ', 0, '1', '2018-05-20 19:19:15'),
(46013, 768, 'b6cc6622e5874a5c0a04e2103d8a7dd0', 1, 1, 1244, ' Détails    Contrat', 0, '1', '2018-05-20 19:19:15'),
(46014, 768, 'c58a3038be080d0c6cdf89e0fd0a8c71', 1, 1, 1245, 'Détails  Contrat', 0, '1', '2018-05-20 19:19:15'),
(46015, 768, '656d41ad5452611636a5d9f966729e39', 1, 1, 1246, 'Renouveler Contrat', 0, '1', '2018-05-20 19:19:15'),
(46016, 768, '9a7cae6e28f8265acf392c94c2c38aec', 1, 1, 1247, 'Résilier Contrat', 0, '1', '2018-05-20 19:19:15'),
(46017, 768, '2e8270e01e3668cfd156816d9107d1f7', 1, 1, 1248, 'Détails   Contrat', 0, '1', '2018-05-20 19:19:15'),
(46018, 768, 'e5c2a867baf3429d758742a021d4795c', 1, 1, 1260, 'Echéances', 0, '1', '2018-05-20 19:19:15'),
(46019, 768, 'dfc236bfafa081e74f23a1c5f631fe78', 1, 1, 1261, 'Echéances', 0, '1', '2018-05-20 19:19:15'),
(46020, 769, '87f4c3ed4713c3bc9e3fef60a6649055', 1, 1, 1250, 'Ajouter contrat', 0, '1', '2018-05-20 19:19:15'),
(46021, 770, '9e49a431d9637544cefa2869fd7278b9', 1, 1, 1251, 'Modifier contrat', 0, '1', '2018-05-20 19:19:15'),
(46022, 771, '1e9395a182a44787e493bc038cd80bbf', 1, 1, 1252, 'Supprimer contrat', 0, '1', '2018-05-20 19:19:15'),
(46023, 772, '460d92834715b149c4db28e1643bd932', 1, 1, 1253, 'Valider contrat', 0, '1', '2018-05-20 19:19:15'),
(46024, 773, 'bbcf2879c2f8f60cfa55fa97c6e79268', 1, 1, 1254, 'Détail contrat', 0, '1', '2018-05-20 19:19:15'),
(46025, 774, 'fe058ccb890b25a54866be7f24a40363', 1, 1, 1255, 'Ajouter échéance ', 0, '1', '2018-05-20 19:19:15'),
(46026, 775, '36a248f56a6a80977e5c90a5c59f39d3', 1, 1, 1256, 'Modifier échéance contrat', 0, '1', '2018-05-20 19:19:15'),
(46027, 776, 'f0567980556249721f24f2fc88ebfed5', 1, 1, 1257, 'Renouveler Contrat', 0, '1', '2018-05-20 19:19:15'),
(46028, 777, 'd3fc6f1bcca0a0250c5f6de29fd72b80', 1, 1, 1258, 'Résilier Contrat', 1, '1', '2018-05-20 19:19:15'),
(46029, 778, '428bf9d4c56394d24e15f5458b077990', 1, 1, 1259, 'Echéances', 1, '1', '2018-05-20 19:19:15'),
(46030, 778, 'b0cff04f8af9234adbc81e7f679c7176', 1, 1, 1263, 'Générer Facture', 0, '1', '2018-05-20 19:19:15'),
(46031, 778, '1596760bb0380a6a77c784ec92eb6fa7', 1, 1, 1265, 'Afficher Facture', 0, '1', '2018-05-20 19:19:15'),
(46032, 779, 'b37af8eb31b7082afa5ad48f0d618f3b', 1, 1, 1262, 'Générer Facture', 1, '1', '2018-05-20 19:19:15'),
(46033, 780, 'd860c94cc554cc0ff03af97a9248d2de', 1, 1, 1264, 'Afficher Facture', 1, '1', '2018-05-20 19:19:15'),
(46034, 609, 'ec45512f34613446e7a2e367d4b4cfbd', 1, 1, 920, 'Gestion Contrats Fournisseurs', 0, '1', '2018-05-20 19:19:15'),
(46035, 609, 'e3c0d7e92dad7f8794b2415c334ec3ff', 1, 1, 921, 'Editer Contrat', 0, '1', '2018-05-20 19:19:15'),
(46036, 609, '9dfff1c8dcb804837200f38e95381420', 1, 1, 922, 'Valider Contrat', 0, '1', '2018-05-20 19:19:15'),
(46037, 609, '9fe39b496077065105a57ccd9ed05863', 1, 1, 923, 'Désactiver Contrat', 0, '1', '2018-05-20 19:19:15'),
(46038, 609, 'faee342ff51dbe9f835529ae5b9b2a0b', 1, 1, 924, 'Détails  Contrat ', 0, '1', '2018-05-20 19:19:15'),
(46039, 609, '83406b6b206ed08878f2b2e854932ae5', 1, 1, 925, 'Détails   Contrat  ', 0, '1', '2018-05-20 19:19:15'),
(46040, 609, '8447888bef30fb983477cc1357ff7e6f', 1, 1, 926, 'Détails    Contrat ', 0, '1', '2018-05-20 19:19:15'),
(46041, 609, '4cc1845128f6a5ff3ed01100292d8ebb', 1, 1, 927, '  Détails    Contrat', 0, '1', '2018-05-20 19:19:15'),
(46042, 609, 'cd82d84c5f70a633b10aae88c34e9159', 1, 1, 928, '  Renouveler   Contrat ', 0, '1', '2018-05-20 19:19:15'),
(46043, 609, 'e9e994a0f8a204f1323fca7ce30931fe', 1, 1, 929, ' Détails  Contrat ', 0, '1', '2018-05-20 19:19:15'),
(46044, 609, 'b9e0a2a0236899590c72d31b878edfb2', 1, 1, 930, ' Renouveler  Contrat ', 0, '1', '2018-05-20 19:19:15'),
(46045, 610, 'ded24eb817021c5a666a677b1565bc5e', 1, 1, 931, 'Ajouter Contrat', 0, '1', '2018-05-20 19:19:15'),
(46046, 611, 'ed6b8695494bf4ed86d5fb18690b3a59', 1, 1, 932, 'Editer Contrat', 0, '1', '2018-05-20 19:19:15'),
(46047, 612, 'b8a40913b5955209994aaa26d0e8c3d4', 1, 1, 933, 'Supprimer Contrat', 0, '1', '2018-05-20 19:19:15'),
(46048, 613, '5efb874e7d73ccd722df806e8275770f', 1, 1, 934, 'Valider Contrat', 0, '1', '2018-05-20 19:19:15'),
(46049, 614, '64a5f976687a8c5f7cd3d672cc5d9c8c', 1, 1, 935, 'Détails Contrat', 0, '1', '2018-05-20 19:19:15'),
(46050, 615, '2cc55c65e79534161108288adb00472b', 1, 1, 936, 'Renouveler  Contrat', 0, '1', '2018-05-20 19:19:15'),
(46051, 432, 'f320732af279d6f2f8ae9c98cd0216de', 1, 1, 613, 'Gestion Départements', 0, '1', '2018-05-20 19:19:15'),
(46052, 432, '96516cd0c72d814d5dcb1d86eacd29ab', 1, 1, 617, 'Editer Département', 0, '1', '2018-05-20 19:19:15'),
(46053, 432, 'ef27a63534fa9fc3bd4b5086a92db546', 1, 1, 619, 'Valider Département', 0, '1', '2018-05-20 19:19:15'),
(46054, 432, '9aed965af4c4b89a5a23c41bf685d403', 1, 1, 620, 'Désactiver Département', 0, '1', '2018-05-20 19:19:15'),
(46055, 433, '722b3ba1c7fe735e87aa7415e5502a4c', 1, 1, 614, 'Ajouter Département', 0, '1', '2018-05-20 19:19:15'),
(46056, 434, 'daeb31006124e562d284aff67360ee19', 1, 1, 615, 'Editer Département', 0, '1', '2018-05-20 19:19:15'),
(46057, 435, 'a775da608fe55c53211d4f1c6e493251', 1, 1, 616, 'Supprimer Département', 0, '1', '2018-05-20 19:19:15'),
(46058, 436, 'bbb96ec910c5000a2006db2f6e8af10a', 1, 1, 618, 'Valider Département', 0, '1', '2018-05-20 19:19:15'),
(46059, 888, '0e79510db7f03b9b6266fc7b4a612153', 1, 1, 1459, 'Gestion Devis', 1, '1', '2018-05-20 19:19:15'),
(46060, 888, 'c15b00a1e37657336df8b6aa0eea2db5', 1, 1, 1460, 'Modifier Devis', 0, '1', '2018-05-20 19:19:15'),
(46061, 888, '7cfdba6bc6bc94c65b97e77746cf49b5', 1, 1, 1461, 'Envoi au client', 0, '1', '2018-05-20 19:19:15'),
(46062, 888, '28e267a2a0647d4cb37b18abb1e7d051', 1, 1, 1462, 'Voir détails', 0, '1', '2018-05-20 19:19:15'),
(46063, 888, 'd34b07afd92adad84e1c4c2ebd92ba95', 1, 1, 1463, 'Voir détails', 0, '1', '2018-05-20 19:19:15'),
(46064, 888, 'f6f55b9d0ba9d704b2861d57cda32477', 1, 1, 1464, 'Réponse Client', 0, '1', '2018-05-20 19:19:15'),
(46065, 888, '4b11c0bfb3f970a541100f7fc334927e', 1, 1, 1465, 'Voir détails', 0, '1', '2018-05-20 19:19:15'),
(46066, 888, '61a0655c2c13039b5b8262b82ae6cb51', 1, 1, 1466, 'Voir détails', 0, '1', '2018-05-20 19:19:15'),
(46067, 888, 'ed30dfbb21d8d24a0da432252358bdf8', 1, 1, 1467, 'Voir détails', 0, '1', '2018-05-20 19:19:15'),
(46068, 888, '7bd2e025ffb3893dea4776e152301716', 1, 1, 1468, 'Débloquer devis', 0, '1', '2018-05-20 19:19:15'),
(46069, 888, '6d9ec7d9ebebcdc921376e7bf0c9fdaf', 1, 1, 1469, 'Valider devis', 0, '1', '2018-05-20 19:19:15'),
(46070, 888, 'b1bcc4a4ab154f110abcf54c0c659fb3', 1, 1, 1470, 'Voir détails', 0, '1', '2018-05-20 19:19:15'),
(46071, 888, '91a90a46e3430c491ab8db654b6e87c4', 1, 1, 1471, 'Voir détails', 0, '1', '2018-05-20 19:19:15'),
(46072, 888, 'cf6178eae84de71449fcee8911b77f40', 1, 1, 1472, 'Renouveler Devis', 0, '1', '2018-05-20 19:19:15'),
(46073, 888, 'c0c64bb86ef45f064af45136b5f28ae7', 1, 1, 1473, 'Voir détails', 0, '1', '2018-05-20 19:19:15'),
(46074, 888, '18f2ec7bc883829e215136a2318755ef', 1, 1, 1474, 'Préparer livraison', 0, '1', '2018-05-20 19:19:15'),
(46075, 889, 'd9eeb330625c1b87e0df00986a47be01', 1, 1, 1475, 'Ajouter Devis', 0, '1', '2018-05-20 19:19:15'),
(46076, 890, 'da93cdb05137e15aed9c4c18bddd746a', 1, 1, 1476, 'Ajouter détail devis', 0, '1', '2018-05-20 19:19:15'),
(46077, 891, 'f9f3c299f9bd0fec014f6bd3f0e06adb', 1, 1, 1477, 'Modifier Devis', 0, '1', '2018-05-20 19:19:15'),
(46078, 892, 'e14cce6f1faf7784adb327581c516b90', 1, 1, 1478, 'Supprimer Devis', 0, '1', '2018-05-20 19:19:15'),
(46079, 893, '38f10871792c133ebcc6040e9a11cde8', 1, 1, 1479, 'Modifier détail Devis', 0, '1', '2018-05-20 19:19:15'),
(46080, 894, '8def42e75fd4aee61c378d9fb303850d', 1, 1, 1480, 'Afficher détail devis', 0, '1', '2018-05-20 19:19:15'),
(46081, 895, '7666e87783b0f5a7eec1eea7593f7dfe', 1, 1, 1481, 'Valider Devis', 0, '1', '2018-05-20 19:19:15'),
(46082, 896, '7f1c48324d8c369da9aa6ab8af35acd8', 1, 1, 1482, 'Validation Client Devis', 0, '1', '2018-05-20 19:19:15'),
(46083, 897, '6adf896091dde0df89f777f31606953c', 1, 1, 1483, 'Débloquer devis', 0, '1', '2018-05-20 19:19:15'),
(46084, 898, '15cbb79dd4a74266158e6b29a83e683c', 1, 1, 1484, 'Archiver Devis', 1, '1', '2018-05-20 19:19:15'),
(46085, 899, 'f520c1e87674cdaf83635d37863de930', 1, 1, 1485, 'Ajout client divers', 1, '1', '2018-05-20 19:19:15'),
(46086, 900, '118fe4b340e728b2cb9ee9607531fae4', 1, 1, 1486, 'Renouveler Devis', 1, '1', '2018-05-20 19:19:15'),
(46087, 901, '9a405d89d749c15a976b939b96a1128b', 1, 1, 1487, 'Préparer livraison', 1, '1', '2018-05-20 19:19:15'),
(46088, 859, '7fde4464cf64b2fca994f7cdc128307e', 1, 1, 1409, 'Gestion des Entrepôts', 1, '1', '2018-05-20 19:19:15'),
(46089, 859, 'dfc69597b3f4c08061386486fd177e5b', 1, 1, 1412, 'Editer Entrepôt', 0, '1', '2018-05-20 19:19:15'),
(46090, 859, '4886df3c47866eac474e1d87f7774850', 1, 1, 1415, 'Valider Entrepôt', 0, '1', '2018-05-20 19:19:15'),
(46091, 859, 'f16f69131a3e43f28acab8db040dbe1c', 1, 1, 1416, 'Désactiver Entrepôt', 0, '1', '2018-05-20 19:19:15'),
(46092, 860, '462994905cf4ea3256839ee181df30f0', 1, 1, 1410, 'Ajouter Entrepôt', 1, '1', '2018-05-20 19:19:15'),
(46093, 861, 'c7c70683c8539bf442fbb3bc145062d9', 1, 1, 1411, 'Editer Entrepôt', 1, '1', '2018-05-20 19:19:15'),
(46094, 862, '883e7763f88a902baf086a152a3c81a5', 1, 1, 1413, 'Supprimer Entrepôt', 1, '1', '2018-05-20 19:19:16'),
(46095, 863, 'c717024f55a777aece4490406767f434', 1, 1, 1414, 'Valider Entrepôt', 1, '1', '2018-05-20 19:19:16'),
(46096, 796, '4c924acb9adc87d8389e8f9842a965c5', 1, 1, 1297, 'Gestion des factures', 0, '1', '2018-05-20 19:19:16'),
(46097, 796, '98a697ec628778765b25e02ba2929d38', 1, 1, 1298, 'Liste complément', 0, '1', '2018-05-20 19:19:16'),
(46098, 796, 'f8b20f7fec99b45b967a431d64b7f061', 1, 1, 1299, 'Liste encaissements', 0, '1', '2018-05-20 19:19:16'),
(46099, 796, '9a51fb5298e39a28af3ad6272fc51177', 1, 1, 1300, 'Valider facture', 0, '1', '2018-05-20 19:19:16'),
(46100, 796, '851f1d4c13f6025f69f5b9315321d350', 1, 1, 1301, 'Désactiver facture', 0, '1', '2018-05-20 19:19:16'),
(46101, 796, '5c79105956d28b5cac52f85784039919', 1, 1, 1302, 'Détail facture', 0, '1', '2018-05-20 19:19:16'),
(46102, 796, '7892721423af84a0b54e90250cf27ee3', 1, 1, 1303, 'Détails Facture', 0, '1', '2018-05-20 19:19:16'),
(46103, 796, '4b69240b3dd04f7a29457008b31d1248', 1, 1, 1304, 'Envoyer au client  ', 0, '1', '2018-05-20 19:19:16'),
(46104, 796, '80a4b2643b95c2836e968411811d3c21', 1, 1, 1305, 'Détails facture', 0, '1', '2018-05-20 19:19:16'),
(46105, 796, '2f679be3c0d7b88529209f86745f9028', 1, 1, 1306, 'Détails facture', 0, '1', '2018-05-20 19:19:16'),
(46106, 796, '429558e9a1e899c11051ea5c9a4f7942', 1, 1, 1307, 'Détails facture', 0, '1', '2018-05-20 19:19:16'),
(46107, 796, '3acd11d8d74fb7e1ba8d5721e96f91bd', 1, 1, 1308, 'Liste encaissements', 0, '1', '2018-05-20 19:19:16'),
(46108, 797, '55c3c5d2d93143b315513b7401043c8b', 1, 1, 1309, 'complements', 0, '1', '2018-05-20 19:19:16'),
(46109, 797, 'dfc4772cc03cf0b92a47f54fc6a2326e', 1, 1, 1310, 'Modifier complément', 0, '1', '2018-05-20 19:19:16'),
(46110, 798, '03a18bdd5201e433a3c523a2b34d059a', 1, 1, 1311, 'Ajouter complément', 0, '1', '2018-05-20 19:19:16'),
(46111, 799, '88d9bc979cd1102eb8196e7f5e6042ca', 1, 1, 1312, 'Encaissement', 0, '1', '2018-05-20 19:19:16'),
(46112, 799, 'c690cc68f5257c0c225b8b8e6126ea56', 1, 1, 1313, 'Modifier encaissement', 0, '1', '2018-05-20 19:19:16'),
(46113, 799, '1dc06f602e8630f273d44aa2751b2127', 1, 1, 1314, 'Détails encaissement', 0, '1', '2018-05-20 19:19:16'),
(46114, 799, '6567dc21b9b744ea7dbcbcbf83df4ac5', 1, 1, 1315, 'Valider encaissement', 0, '1', '2018-05-20 19:19:16'),
(46115, 799, 'bc335bbc5e0debff602b4e5325c89a99', 1, 1, 1316, 'Détails encaissement', 0, '1', '2018-05-20 19:19:16'),
(46116, 800, 'e4866b292dbc3c9c5d9cc37273a5b498', 1, 1, 1317, 'Ajouter encaissement', 0, '1', '2018-05-20 19:19:16'),
(46117, 801, '8665be10959f39df4f149962eb70041f', 1, 1, 1318, 'Modifier complément', 0, '1', '2018-05-20 19:19:16'),
(46118, 802, '585d411904bf7d9e83d21b2810ff1d6c', 1, 1, 1319, 'Modifier encaissement', 0, '1', '2018-05-20 19:19:16'),
(46119, 803, '8c8b058a4d030cdc8b49c9008abb2e92', 1, 1, 1320, 'Supprimer complément', 0, '1', '2018-05-20 19:19:16'),
(46120, 804, '6bf7d5180940f03567a5d711e8563ba4', 1, 1, 1321, 'Supprimer encaissement', 0, '1', '2018-05-20 19:19:16'),
(46121, 805, '256abad0ec8e3bc8ed1c0653ff177255', 1, 1, 1322, 'Valider facture', 0, '1', '2018-05-20 19:19:16'),
(46122, 806, 'b5dc5719c1f96df7334f371dcf51a5b6', 1, 1, 1323, 'Détail encaissement', 0, '1', '2018-05-20 19:19:16'),
(46123, 807, '16fbf6fdcbb72f863bcf7e4ef28d8e75', 1, 1, 1324, 'Détails facture', 0, '1', '2018-05-20 19:19:16'),
(46124, 808, '5efdeb41007109ca99f23f0756217827', 1, 1, 1325, 'Désactiver Facture', 0, '1', '2018-05-20 19:19:16'),
(46125, 809, '1127d08fb22f425fd7913c3df1b9884f', 1, 1, 1326, 'Valider encaissement', 1, '1', '2018-05-20 19:19:16'),
(46126, 810, '1bacb05aca2d17b42b1de767a8ad45de', 1, 1, 1327, 'Envoyer Facture', 1, '1', '2018-05-20 19:19:16'),
(46127, 502, '6beb279abea6434e3b73229aebadc081', 1, 1, 725, 'Gestion Fournisseurs', 0, '1', '2018-05-20 19:19:16'),
(46128, 502, 'ff95747f3a590b6539803f2a9a394cd5', 1, 1, 730, 'Editer Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46129, 502, 'fea982f5074995d4ccd6211a71ab2680', 1, 1, 731, 'Valider Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46130, 502, '1d0411a0dec15fc28f054f1a79d95618', 1, 1, 732, 'Désactiver Fournisseur', 0, '1', '2018-05-20 19:19:16');
INSERT INTO `rules_action` (`id`, `appid`, `idf`, `service`, `userid`, `action_id`, `descrip`, `type`, `creusr`, `credat`) VALUES
(46131, 502, 'a52affdd109b9362ce47ff18aad53e2a', 1, 1, 737, 'Détails Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46132, 502, 'c6fe5f222dd563204188e8bf0d69bd9e', 1, 1, 738, 'Détails  Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46133, 503, 'd644015625a9603adb2fcc36167aeb73', 1, 1, 726, 'Ajouter Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46134, 504, '58c6694abfd3228d927a5d5a06d40b94', 1, 1, 727, 'Editer Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46135, 505, 'd072f81cd779e4b0152953241d713ca3', 1, 1, 728, 'Supprimer Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46136, 506, '657351ce5aa227513e3b50dea77db918', 1, 1, 729, 'Valider Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46137, 508, '83b693fe35a1be29edafe4f6170641aa', 1, 1, 736, 'Détails Fournisseur', 0, '1', '2018-05-20 19:19:16'),
(46138, 542, '72db1c2280dc3eb6405908c1c5b6c815', 1, 1, 810, 'Information société', 0, '1', '2018-05-20 19:19:16'),
(46139, 637, 'b8e62907d367fb44d644a5189cd07f42', 1, 1, 978, 'Modules', 1, '1', '2018-05-20 19:19:16'),
(46140, 637, '05ce9e55686161d99e0714bb86243e5b', 1, 1, 979, 'Editer Module', 0, '1', '2018-05-20 19:19:16'),
(46141, 637, '819cf9c18a44cb80771a066768d585f2', 1, 1, 980, 'Exporter Module', 0, '1', '2018-05-20 19:19:16'),
(46142, 637, 'd2fc3ee15cee5208a8b9c70f1e53c196', 1, 1, 981, 'Liste task modul', 0, '1', '2018-05-20 19:19:16'),
(46143, 637, 'ad75e6b877f20e3d6fc1789da4dcb3e6', 1, 1, 982, 'Editer Module', 0, '1', '2018-05-20 19:19:16'),
(46144, 637, '064a9b0eff1006fd4f25cb4eaf894ca1', 1, 1, 983, 'Liste task modul Setting', 0, '1', '2018-05-20 19:19:16'),
(46145, 637, 'ac4eb0c94da00a48ad5d995f5e9e9366', 1, 1, 984, 'MAJ Module', 0, '1', '2018-05-20 19:19:16'),
(46146, 638, '44bd5341b0ab41ced21db8b3e92cf5aa', 1, 1, 985, 'Ajouter un Modul', 1, '1', '2018-05-20 19:19:16'),
(46147, 640, '8653b156f1a4160a12e5a94b211e59a2', 1, 1, 986, 'Liste Action Task', 0, '1', '2018-05-20 19:19:16'),
(46148, 640, '86aced763bc02e1957a5c740fb37b4f7', 1, 1, 987, 'Supprimer Application', 0, '1', '2018-05-20 19:19:16'),
(46149, 640, 'f07352e32fe86da1483c6ab071b7e7a9', 1, 1, 988, 'Ajout Affichage WF', 0, '1', '2018-05-20 19:19:16'),
(46150, 641, '1c452aff8f1551b3574e15b74147ea56', 1, 1, 989, 'Ajouter Task Modul', 1, '1', '2018-05-20 19:19:16'),
(46151, 642, 'f085fe4610576987db963501297e4d91', 1, 1, 990, 'Editer Task Modul', 1, '1', '2018-05-20 19:19:16'),
(46152, 642, '38702c272a6f4d334c2f4c3684c8b163', 1, 1, 991, 'Ajouter action modul', 1, '1', '2018-05-20 19:19:16'),
(46153, 643, 'cbae1ebe850f6dd8841426c6fedf1785', 1, 1, 992, 'Liste Action Task', 1, '1', '2018-05-20 19:19:16'),
(46154, 643, 'e30471396f9b86ccdcc94943d80b679a', 1, 1, 993, 'Editer Task Action', 0, '1', '2018-05-20 19:19:16'),
(46155, 644, '502460cd9327b46ee7af0a258ebf8c80', 1, 1, 994, 'Ajouter Action Task', 1, '1', '2018-05-20 19:19:16'),
(46156, 645, '13c107211904d4a2e65dd65c60ec7272', 1, 1, 995, 'Supprimer Application', 1, '1', '2018-05-20 19:19:16'),
(46157, 646, '8c8acf9cf3790b16b1fae26823f45eab', 1, 1, 996, 'Importer des modules', 1, '1', '2018-05-20 19:19:16'),
(46158, 647, '2f4518dab90b706e2f4acd737a0425d8', 1, 1, 997, 'Ajouter Module paramétrage', 1, '1', '2018-05-20 19:19:16'),
(46159, 648, '8e0c0212d8337956ac2f4d6eb180d74b', 1, 1, 998, 'Editer Module paramètrage', 1, '1', '2018-05-20 19:19:16'),
(46160, 649, 'fc54953b47b7fcb11cc14c0c2e2125f0', 1, 1, 999, 'Ajouter Autorisation Etat', 1, '1', '2018-05-20 19:19:16'),
(46161, 650, '966ec2dd83e6006c2d0ff1d1a5f12e33', 1, 1, 1000, 'Editer Task Action', 1, '1', '2018-05-20 19:19:16'),
(46162, 651, '3473119f6683893a3f1372dbf7d811e1', 1, 1, 1001, 'MAJ Module', 1, '1', '2018-05-20 19:19:16'),
(46163, 652, '2e2346bd422536c1d996ff25f9e71357', 1, 1, 1002, 'Dupliquer Action Task', 0, '1', '2018-05-20 19:19:16'),
(46164, 653, '8a3634181ae5bc9223b689a310158962', 1, 1, 1003, 'Supprimer Task action', 0, '1', '2018-05-20 19:19:16'),
(46165, 654, '8afb3c669307183cd3b7d189fbf204d7', 1, 1, 1004, 'Affichage Work Flow', 0, '1', '2018-05-20 19:19:16'),
(46166, 864, '530dbb6317ed3d348cd55d1f9a09e361', 1, 1, 1417, 'Mouvements de Stock', 1, '1', '2018-05-20 19:19:16'),
(46167, 475, '605450f3d7c84701b986fa31e1e9fa43', 1, 1, 684, 'Gestion Pays', 0, '1', '2018-05-20 19:19:16'),
(46168, 475, '29ba6cc689eca63dbafb109ec58bc4d6', 1, 1, 689, 'Editer Pays', 0, '1', '2018-05-20 19:19:16'),
(46169, 475, '763fe13212b4324590518773cd9a36fa', 1, 1, 690, 'Valider Pays', 0, '1', '2018-05-20 19:19:16'),
(46170, 475, '3c8427c7313d35219b17572efd380b17', 1, 1, 691, 'Désactiver Pays', 0, '1', '2018-05-20 19:19:16'),
(46171, 476, '3cd55a55307615d72aae84c6b5cf99bc', 1, 1, 685, 'Ajouter Pays', 0, '1', '2018-05-20 19:19:16'),
(46172, 477, 'cfe617d7bc6a9c7d8b86c468f21396f2', 1, 1, 686, 'Editer Pays', 0, '1', '2018-05-20 19:19:16'),
(46173, 478, 'b768486aeb655c48cc411c11fa60e150', 1, 1, 687, 'Supprimer Pays', 0, '1', '2018-05-20 19:19:16'),
(46174, 479, '15e4e24f320daa9d563ae62acff9e586', 1, 1, 688, 'Valider Pays', 0, '1', '2018-05-20 19:19:16'),
(46175, 728, '192715027870a4a612fd44d562e2752f', 1, 1, 1151, 'Gestion des produits', 0, '1', '2018-05-20 19:19:16'),
(46176, 728, 'cb96e99d5f8e381637d1ac83f1a21f1c', 1, 1, 1152, 'Modifier  produit', 0, '1', '2018-05-20 19:19:16'),
(46177, 728, '64e84ff11fea7f68bcf6a5b744c36081', 1, 1, 1153, 'Détail  produit', 0, '1', '2018-05-20 19:19:16'),
(46178, 728, '0c94d85f4ee23656a01155ad1af5001c', 1, 1, 1154, 'Valider  produit', 0, '1', '2018-05-20 19:19:16'),
(46179, 728, '6b087b20929483bb07f8862b39e41f07', 1, 1, 1155, 'Désactiver produit', 0, '1', '2018-05-20 19:19:16'),
(46180, 728, '68c9513decd1228ca1dc406ab4f28bbd', 1, 1, 1156, 'Achat  produit', 0, '1', '2018-05-20 19:19:16'),
(46181, 728, '41b9c4b7028269d4540915d6ec14ee79', 1, 1, 1157, 'Détails Produit', 0, '1', '2018-05-20 19:19:16'),
(46182, 728, '5af94daa3128b843b812f150bc553947', 1, 1, 1488, 'Achat  produit', 0, '1', '2018-05-20 19:19:16'),
(46183, 728, '2c3dc91d46bda8401471d8107103246a', 1, 1, 1489, 'Détails Produit', 0, '1', '2018-05-20 19:19:16'),
(46184, 729, '93e893c307a6fa63e392f78751ec70ce', 1, 1, 1158, 'Ajouter produit', 0, '1', '2018-05-20 19:19:16'),
(46185, 730, 'bcf3beada4a98e8145af2d4fbb744f01', 1, 1, 1159, 'Modifier produit', 0, '1', '2018-05-20 19:19:16'),
(46186, 731, '796427ec57f7c13d6b737055ae686b34', 1, 1, 1160, 'Detail produit', 0, '1', '2018-05-20 19:19:16'),
(46187, 732, '1fb8cd1a179be07586fa7db05013dd37', 1, 1, 1161, 'Valider produit', 0, '1', '2018-05-20 19:19:16'),
(46188, 733, '7779e98d2111faedf458f7aeb548294e', 1, 1, 1162, 'Supprimer produit', 0, '1', '2018-05-20 19:19:16'),
(46189, 734, 'f8c9a7413089566d1db20dcc5ca17e03', 1, 1, 1164, 'Modifier achat', 0, '1', '2018-05-20 19:19:16'),
(46190, 734, '682b4328ee832101a44dac86b22d5757', 1, 1, 1165, 'Détail achat', 0, '1', '2018-05-20 19:19:16'),
(46191, 734, 'd1ebf1c5482ddf06721b11ec64afb744', 1, 1, 1166, 'Valider achat', 0, '1', '2018-05-20 19:19:16'),
(46192, 734, '368a1e91fc63e263eb01d85a34ecd89b', 1, 1, 1167, 'Désactiver achat', 0, '1', '2018-05-20 19:19:16'),
(46193, 735, '659be5cd86a12eba7e59c52d60198a36', 1, 1, 1168, 'Ajoute achat', 0, '1', '2018-05-20 19:19:16'),
(46194, 736, '8415336a17e8ca26f3eca5741863f3b2', 1, 1, 1169, 'Modifier achat', 0, '1', '2018-05-20 19:19:16'),
(46195, 737, '2c3b4875b72f7da6a87b5c0d7e85f51d', 1, 1, 1170, 'Supprimer achat', 0, '1', '2018-05-20 19:19:16'),
(46196, 738, 'd4180eb7a4ff86c598f441ffd4543f36', 1, 1, 1171, 'Détail achat', 0, '1', '2018-05-20 19:19:16'),
(46197, 739, '4a4c9b096bad58a96d5ea6f93d66e81c', 1, 1, 1172, 'Valider achat', 0, '1', '2018-05-20 19:19:16'),
(46198, 720, '1eb847d87adcad78d5e951e6110061e5', 1, 1, 1137, 'Gestion Proforma', 0, '1', '2018-05-20 19:19:16'),
(46199, 720, '44ef6849d8d5d17d8e0535187e923d32', 1, 1, 1138, 'Editer proforma', 0, '1', '2018-05-20 19:19:16'),
(46200, 720, 'b7ce06be726011362a271678547a803c', 1, 1, 1139, 'Valider Proforma', 0, '1', '2018-05-20 19:19:16'),
(46201, 720, 'abd8c50f1d2ef4beeeddb68a72973587', 1, 1, 1140, 'Détail Proforma', 0, '1', '2018-05-20 19:19:16'),
(46202, 720, '35a88b5c359908b063ac98cafc622987', 1, 1, 1141, 'Détail Proforma', 0, '1', '2018-05-20 19:19:16'),
(46203, 720, 'e20d83df90355eca2a65f56a2556601f', 1, 1, 1142, 'Détail Proforma', 0, '1', '2018-05-20 19:19:16'),
(46204, 720, '252ed64d8956e20fb88c1be41688f74a', 1, 1, 1143, 'Envoi proforma au client', 0, '1', '2018-05-20 19:19:16'),
(46205, 721, 'd5a6338765b9eab63104b59f01c06114', 1, 1, 1144, 'Ajouter pro-forma', 0, '1', '2018-05-20 19:19:16'),
(46206, 722, '95831bde77bc886d6ab4dd5e734de743', 1, 1, 1145, 'Editer proforma', 0, '1', '2018-05-20 19:19:16'),
(46207, 723, 'cbb4e1efa1c05b42d25a3a6bcab038a2', 1, 1, 1146, 'Ajouter détail proforma', 0, '1', '2018-05-20 19:19:16'),
(46208, 724, 'e9f745054778257a255452c6609461a0', 1, 1, 1147, 'valider Proforma', 0, '1', '2018-05-20 19:19:16'),
(46209, 725, 'defef148c404c7e6ac79e4783e0a7ab7', 1, 1, 1148, 'Détail Pro-forma', 0, '1', '2018-05-20 19:19:16'),
(46210, 726, '53008d64edf241c937a06f03eff139aa', 1, 1, 1149, 'Editer détail proforma', 0, '1', '2018-05-20 19:19:16'),
(46211, 727, '30e9d3d1ad17eb7f1fc0d5cbb9b58482', 1, 1, 1150, 'Supprimer proforma', 1, '1', '2018-05-20 19:19:16'),
(46212, 470, 'd57b16b3aad4ce59f909609246c4fd36', 1, 1, 676, 'Gestion des régions', 0, '1', '2018-05-20 19:19:16'),
(46213, 470, 'd2e007184668dd70b9bae44d46d28ded', 1, 1, 677, 'Modifier région', 0, '1', '2018-05-20 19:19:16'),
(46214, 470, 'e74403c99ac8325b78735c531a20442f', 1, 1, 678, 'Valider région', 0, '1', '2018-05-20 19:19:16'),
(46215, 470, '7397a0fab078728bd5c53be61022d5ce', 1, 1, 679, 'Désactiver région', 0, '1', '2018-05-20 19:19:16'),
(46216, 471, '0237bd41cf70c3529681b4ccb041f1fd', 1, 1, 680, 'Ajouter région', 0, '1', '2018-05-20 19:19:16'),
(46217, 472, '6d290f454da473cb8a557829a410c3f1', 1, 1, 681, 'Modifier région', 0, '1', '2018-05-20 19:19:16'),
(46218, 473, '008cd9ea5767c739675fef4e1261cfe8', 1, 1, 682, 'Valider région', 0, '1', '2018-05-20 19:19:16'),
(46219, 474, 'fc477e6a4c90cd427ae81e555c11d6a9', 1, 1, 683, 'Supprimer région', 0, '1', '2018-05-20 19:19:16'),
(46220, 34, '83b9fa44466da4bcd7f8304185bfeac8', 1, 1, 28, 'Services', 0, '1', '2018-05-20 19:19:16'),
(46221, 34, '3c388c1e842851df49abe9ee73c0a2e7', 1, 1, 33, 'Valider Service', 0, '1', '2018-05-20 19:19:16'),
(46222, 34, 'dcb9555d5ca1d108e9fa95daa9da4b3a', 1, 1, 34, 'Supprimer Service', 0, '1', '2018-05-20 19:19:16'),
(46223, 34, '74950fb3fd858404b6048c1e81bd7c9a', 1, 1, 144, 'Modifier Service', 0, '1', '2018-05-20 19:19:16'),
(46224, 35, '55043bc4207521e3010e91d6267f5302', 1, 1, 29, 'Ajouter Service', 1, '1', '2018-05-20 19:19:16'),
(46225, 36, '2fea3d893f6b6e81467ddd2a744e4a76', 1, 1, 30, 'Modifier Service', 1, '1', '2018-05-20 19:19:16'),
(46226, 37, '1a0d5897d31b4d5e29022671c1112f59', 1, 1, 31, 'Valider Service', 1, '1', '2018-05-20 19:19:16'),
(46227, 38, '42083d4e159baf7c2ace2bb977e2b0a0', 1, 1, 32, 'Supprimer Service', 1, '1', '2018-05-20 19:19:16'),
(46228, 858, '79c262a9849332f387662790b8da4399', 1, 1, 1408, 'Gestion de Stock', 1, '1', '2018-05-20 19:19:16'),
(46229, 886, 'c88249c68efc019ecd2ba5a245337841', 1, 1, 1456, 'Stock Actuel', 1, '1', '2018-05-20 19:19:16'),
(46230, 543, 'a1c5a2657cc1b2ff6f85c6fe8f1c51ac', 1, 1, 811, 'Paramètrage Système', 0, '1', '2018-05-20 19:19:16'),
(46231, 543, 'de6285d9c0027ff8bccdf2af385ac337', 1, 1, 812, 'Editer paramètre', 0, '1', '2018-05-20 19:19:16'),
(46232, 544, '82f83d9d3d30fdef00d4c3ef96f0f899', 1, 1, 813, 'Ajouter Paramètre', 0, '1', '2018-05-20 19:19:16'),
(46233, 545, 'f0e54f346e9dcfdff65274709ce2c8ca', 1, 1, 814, 'Editer paramètre', 0, '1', '2018-05-20 19:19:16'),
(46234, 546, 'aaccd24eaf085b8f18115c9c7653d401', 1, 1, 815, 'Supprimer Paramètre', 0, '1', '2018-05-20 19:19:16'),
(46235, 865, '558708106fa0f9c46f98e4d1e5fdf191', 1, 1, 1418, 'Gestion Tickets ', 0, '1', '2018-05-20 19:19:16'),
(46236, 865, '5f239991de8d679e13e20e7a1a6c8433', 1, 1, 1419, 'Modifier ticket   ', 0, '1', '2018-05-20 19:19:16'),
(46237, 865, 'd0f2728310c81c3c323da9c3ec91d998', 1, 1, 1420, 'Affecter ticket ', 0, '1', '2018-05-20 19:19:16'),
(46238, 865, 'db7e28569171b1218d7aa12f75684aa2', 1, 1, 1421, 'Détails ticket', 0, '1', '2018-05-20 19:19:16'),
(46239, 865, '7813165051eca9e0dd0809ffc571b721', 1, 1, 1422, 'Détails ticket   ', 0, '1', '2018-05-20 19:19:16'),
(46240, 865, 'ade7658a655147c067bd85e554f5493b', 1, 1, 1423, 'Reaffecter ticket', 0, '1', '2018-05-20 19:19:16'),
(46241, 865, '599cb4aa075b2cc84746e15f14cd5e41', 1, 1, 1424, 'Ajouter action', 0, '1', '2018-05-20 19:19:16'),
(46242, 865, '51691230fcf4cfd07729acff525de150', 1, 1, 1425, 'Confirmer Clôture', 0, '1', '2018-05-20 19:19:16'),
(46243, 865, 'c6c0ab5988aab9c83960e0a9f261bfae', 1, 1, 1426, 'Détails ticket', 0, '1', '2018-05-20 19:19:16'),
(46244, 865, 'f0ec59382bfa1553e2acb2cee8f0e8bf', 1, 1, 1427, 'Réaffecter ticket', 0, '1', '2018-05-20 19:19:16'),
(46245, 865, '13a62e53e80790158f2d898c2ade40de', 1, 1, 1428, 'Détails ticket', 0, '1', '2018-05-20 19:19:16'),
(46246, 866, '62191d5df0e93231d769d2b17e3b2d68', 1, 1, 1429, 'Ajouter ticket', 1, '1', '2018-05-20 19:19:16'),
(46247, 867, 'f0a2162636fb154c6f9361b86acd87d3', 1, 1, 1430, 'Modifier ticket', 1, '1', '2018-05-20 19:19:16'),
(46248, 868, '962353cac56b445aa4cc0073d1fa3b21', 1, 1, 1431, 'Supprimer ticket', 1, '1', '2018-05-20 19:19:16'),
(46249, 869, '9f7fa9f4122d308b77bd17e2b57bdd3e', 1, 1, 1432, 'Reafecter technicien', 1, '1', '2018-05-20 19:19:16'),
(46250, 870, 'ebe36becbc7f17cb4157d27d62ca7c45', 1, 1, 1433, 'Affecter ticket', 1, '1', '2018-05-20 19:19:16'),
(46251, 871, '73a480d433c6b5e4d130e83eb8d734f8', 1, 1, 1434, 'Détails ticket', 1, '1', '2018-05-20 19:19:16'),
(46252, 872, 'f496ab30882773264b90dd95dac97e07', 1, 1, 1435, 'Réaffecter ticket', 1, '1', '2018-05-20 19:19:16'),
(46253, 873, 'aea1d98c0b188c62f976936454e99bf2', 1, 1, 1436, 'Ajouter action', 1, '1', '2018-05-20 19:19:16'),
(46254, 874, '4f9403ccb1cf450f3ee7dc695e9d8f77', 1, 1, 1437, 'supprimer action ticket', 0, '1', '2018-05-20 19:19:16'),
(46255, 875, '7ee7f4b765ab9f1ac4f2ef7a5a34b988', 1, 1, 1438, 'Modifier action', 1, '1', '2018-05-20 19:19:16'),
(46256, 876, 'a4dd36b475e19e7f31667939ef1c5cf5', 1, 1, 1439, 'Résolution Réussi', 1, '1', '2018-05-20 19:19:16'),
(46257, 877, '775d77d66d847962bc363e3c8500004c', 1, 1, 1440, 'Ticket cloturé', 1, '1', '2018-05-20 19:19:16'),
(46258, 878, 'ca13381e080bc38cc9505039f618df36', 1, 1, 1441, 'Détails action', 1, '1', '2018-05-20 19:19:16'),
(46259, 460, 'b6b6bfbd070b5b3dd84acedae7b854e9', 1, 1, 660, 'Gestion des types de produits', 0, '1', '2018-05-20 19:19:16'),
(46260, 460, '3c5400b775264499825a039d66aa9c90', 1, 1, 661, 'Modifier type', 0, '1', '2018-05-20 19:19:16'),
(46261, 460, 'dcf55bc300d690af4c81e4d2335e60e5', 1, 1, 662, 'Valider type', 0, '1', '2018-05-20 19:19:16'),
(46262, 460, '230b9554d37da1c71986af94962cb340', 1, 1, 663, 'Désactiver type', 0, '1', '2018-05-20 19:19:16'),
(46263, 461, 'e0d163499b4ba11d6d7a648bc6fc6de6', 1, 1, 664, 'Ajouter un type', 0, '1', '2018-05-20 19:19:16'),
(46264, 462, 'ac5a6d087b3c8db7501fa5137a47773e', 1, 1, 665, 'Modifier type', 0, '1', '2018-05-20 19:19:16'),
(46265, 463, '2e8242a93a62a264ad7cfc953967f575', 1, 1, 666, 'Valider type', 0, '1', '2018-05-20 19:19:16'),
(46266, 464, 'e3725ba15ca483b9278f68553eca5918', 1, 1, 667, 'Supprimer type', 0, '1', '2018-05-20 19:19:16'),
(46267, 480, '312fd18860781a7b1b7e33587fa423d4', 1, 1, 692, 'Gestion Type Echeance', 0, '1', '2018-05-20 19:19:16'),
(46268, 480, '46ad76148075d6b458f43e84ddf00791', 1, 1, 697, 'Editer Type Echéance', 0, '1', '2018-05-20 19:19:16'),
(46269, 480, 'add2bf057924e606653fbf5bbd65ca09', 1, 1, 698, 'Valider Type Echéance', 0, '1', '2018-05-20 19:19:16'),
(46270, 480, '463d9e1e8367736b958f0dd84b4e36d5', 1, 1, 699, 'Désactiver Type Echéance', 0, '1', '2018-05-20 19:19:16'),
(46271, 481, '76170b14c7b6f1f7058d079fe24f739b', 1, 1, 693, 'Ajouter Type Echéance', 0, '1', '2018-05-20 19:19:16'),
(46272, 482, 'decc5ed58c4d91e6967c9c67e0975cf0', 1, 1, 694, 'Editer Type Echéance', 0, '1', '2018-05-20 19:19:16'),
(46273, 483, '89db6f23dd8e96a69c6a97f556c44e14', 1, 1, 695, 'Supprimer Type Echéance', 0, '1', '2018-05-20 19:19:16'),
(46274, 484, '7527021168823e0118d44297c7684d44', 1, 1, 696, 'Valider Type Echéance', 0, '1', '2018-05-20 19:19:16'),
(46275, 465, '55ecbb545a49c70c0b728bb0c7951077', 1, 1, 668, 'Gestion des unités de vente', 0, '1', '2018-05-20 19:19:16'),
(46276, 465, '67acd70eb04242b7091d9dcbb08295d7', 1, 1, 669, 'Modifier unité ', 0, '1', '2018-05-20 19:19:16'),
(46277, 465, '7363022ed5ad047bfe86d3de4b75b1f4', 1, 1, 670, 'Valider unité', 0, '1', '2018-05-20 19:19:16'),
(46278, 465, 'ec77eb95736c27bfc269cbffc8e113f1', 1, 1, 671, 'Désactiver unité', 0, '1', '2018-05-20 19:19:16'),
(46279, 466, '3a5e8dfe211121eda706f8b6d548d111', 1, 1, 672, 'ajouter une unité', 0, '1', '2018-05-20 19:19:16'),
(46280, 467, '9b7a578981de699286376903e96bc3c7', 1, 1, 673, 'Modifier une unité', 0, '1', '2018-05-20 19:19:16'),
(46281, 468, '62355588366c13ddbadc7a7ca1d226ad', 1, 1, 674, 'Valider une unité', 0, '1', '2018-05-20 19:19:16'),
(46282, 469, 'e5f53a3aaa324415d781156396938101', 1, 1, 675, 'Supprimer une unité', 0, '1', '2018-05-20 19:19:16'),
(46283, 709, '56de23d30d6c54297c8d9772cd3c7f57', 1, 1, 1115, 'Utilisateurs', 1, '1', '2018-05-20 19:19:16'),
(46284, 709, 'e656756fb7b39a4e6ddcabca75ff2970', 1, 1, 1116, 'Editer Utilisateur', 0, '1', '2018-05-20 19:19:16'),
(46285, 709, 'c073a277957ca1b9f318ac3902555708', 1, 1, 1117, 'Permissions', 0, '1', '2018-05-20 19:19:16'),
(46286, 709, 'c51499ddf7007787c4434661c658bbd1', 1, 1, 1118, 'Désactiver compte', 0, '1', '2018-05-20 19:19:16'),
(46287, 709, '10096b6f54456bcfc85081523ee64cf6', 1, 1, 1119, 'Supprimer utilisateur', 0, '1', '2018-05-20 19:19:16'),
(46288, 709, 'a0999cbed820aff775adf27276ee54a4', 1, 1, 1120, 'Editer Utilisateur', 0, '1', '2018-05-20 19:19:16'),
(46289, 709, '9aa6877656339ddff2478b20449a924b', 1, 1, 1121, 'Activer compte', 0, '1', '2018-05-20 19:19:16'),
(46290, 709, 'f4c79bb797b92dfa826b51a44e3171af', 1, 1, 1122, 'Utilisateurs', 0, '1', '2018-05-20 19:19:16'),
(46291, 709, 'd7f7afd70a297e5c239f6cf271138390', 1, 1, 1123, 'Utilisateur Archivé', 0, '1', '2018-05-20 19:19:16'),
(46292, 709, '17c98287fb82388423e04d24404cf662', 1, 1, 1124, 'Permissions', 0, '1', '2018-05-20 19:19:16'),
(46293, 709, '2c1c5556f30585c5b7c93fbbeaa98595', 1, 1, 1125, 'Historique session', 0, '1', '2018-05-20 19:19:16'),
(46294, 709, '7fd4ca84d162b70d3a4f0bad73e0e4b3', 1, 1, 1126, 'Liste Activitées', 0, '1', '2018-05-20 19:19:16'),
(46295, 710, 'df91a8e6f8ee2cde64495fc0cc7d6c6f', 1, 1, 1127, 'Ajouter Utilisateurs', 1, '1', '2018-05-20 19:19:16'),
(46296, 711, '2bb46b52eab9eecbdbba35605da07234', 1, 1, 1128, 'Editer Utilisateurs', 1, '1', '2018-05-20 19:19:16'),
(46297, 712, '3f59a1326df27378304e142ab3bec090', 1, 1, 1129, 'Permission', 1, '1', '2018-05-20 19:19:16'),
(46298, 713, 'b919571c88d036f8889742a81a4f41fd', 1, 1, 1130, 'Supprimer utilisateur', 1, '1', '2018-05-20 19:19:16'),
(46299, 714, '38f89764a26e39ce029cd3132c12b2a5', 1, 1, 1131, 'Compte utilisateur', 1, '1', '2018-05-20 19:19:16'),
(46300, 715, 'f988a608f35a0bc551cb038b1706d207', 1, 1, 1132, 'Activer utilisateur', 1, '1', '2018-05-20 19:19:16'),
(46301, 716, 'b7b3a09fdd73a5b0a3e5ed8a2828f548', 1, 1, 1133, 'Désactiver l''utilisateur', 1, '1', '2018-05-20 19:19:16'),
(46302, 717, '0d374b7e2fe21a2e2641c092a3c7f2e9', 1, 1, 1134, 'Changer le mot de passe', 1, '1', '2018-05-20 19:19:16'),
(46303, 718, '6f642ee30722158f0318653b9113b887', 1, 1, 1135, 'History', 1, '1', '2018-05-20 19:19:16'),
(46304, 719, 'cc907fac13631903d129c137d671d718', 1, 1, 1136, 'Activities', 1, '1', '2018-05-20 19:19:16'),
(46305, 430, '3d4eaa53061f51b0c4435bd8e4b89c17', 1, 1, 611, 'Gestion Vente', 0, '1', '2018-05-20 19:19:16'),
(46306, 89, '2c3b01c696ff401a2ac9ffedb7a06e4a', 1, 1, 114, 'Gestion Villes', 1, '1', '2018-05-20 19:19:16'),
(46307, 89, 'b9649163b368f863a0e8036f11cd81ae', 1, 1, 119, 'Editer Ville', 0, '1', '2018-05-20 19:19:16'),
(46308, 89, '89dec6dabcb210cdb9dd28bbef90d43e', 1, 1, 121, 'Editer Ville', 0, '1', '2018-05-20 19:19:16'),
(46309, 89, '4a2edbdcbda34c9d3d1e6abe73643b37', 1, 1, 602, 'Valider Ville', 0, '1', '2018-05-20 19:19:16'),
(46310, 89, '0c8ad6595a4516be83ba5a9cdb7ea9a1', 1, 1, 603, 'Désactiver Ville', 0, '1', '2018-05-20 19:19:16'),
(46311, 90, 'e152b9052d3dcfcac593489dbdc0f61c', 1, 1, 115, 'Ajouter ville', 1, '1', '2018-05-20 19:19:16'),
(46312, 91, '3107e0cd0e0df14c4e94aa088e4457d7', 1, 1, 116, 'Editer Ville', 1, '1', '2018-05-20 19:19:16'),
(46313, 92, 'da79d9214ed5819d7f4f1e3070629a3d', 1, 1, 117, 'Supprimer Ville', 1, '1', '2018-05-20 19:19:16'),
(46314, 423, 'fe03a68d17c62ff2c27329573a1b3550', 1, 1, 601, 'Valider Ville', 0, '1', '2018-05-20 19:19:16');
...
CREATE TABLE IF NOT EXISTS `rules_action_temp` (
  ...
  KEY `rules_action_user_sys` (`userid`),
  KEY `rule_action_service_id` (`service`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table store rules for each user for each App and action' AUTO_INCREMENT=256 ;
...
(291, 'aeb26fa670c3803ab48e563f23d4d1f4', 'admin', '2018-05-02 09:39:12', '2018-05-02 22:04:25', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(292, '3e77549fbe40f9ce1bbbc32e0ba6e652', 'admin', '2018-05-02 22:10:19', '2018-05-03 20:42:06', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(293, '50ec9d3f8b62695b23966708c42aa2e5', 'admin', '2018-05-03 21:07:27', '2018-05-05 13:29:05', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(294, 'ae9180b79172dfe6aeb7b651a1a99148', 'admin', '2018-05-05 22:23:54', '2018-05-07 00:02:57', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(295, 'a23ea9f047832c84b5eba06942420bf5', 'admin', '2018-05-07 00:11:51', '2018-05-07 09:25:03', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(296, '12f5b38aa62d9c4c1a9a4ae6b2b2d34a', 'admin', '2018-05-07 09:25:10', '2018-05-07 21:44:03', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(297, 'd597c677ad76dfe62ac0148fb2ae6944', 'admin', '2018-05-07 21:44:08', '2018-05-08 09:42:55', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(298, '55f0dfb8959874a1aba9ad19ace3fe0b', 'admin', '2018-05-08 09:42:55', '2018-05-08 21:44:46', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(299, '95abeb5d07dd1c99e8867899eb129ece', 'admin', '2018-05-08 21:50:46', '2018-05-09 10:35:31', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(300, '56bc33004e28404714fd0b5fca3bdc48', 'admin', '2018-05-09 10:44:26', '2018-05-10 22:36:35', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(301, '26175e330aefa3e3c494a389a344abc5', 'admin', '2018-05-10 22:56:40', '2018-05-11 18:43:34', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(302, '514b08a5077e29c089107c3328425695', 'admin', '2018-05-11 18:52:48', '2018-05-12 16:59:58', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(303, '7a4b74890277f5d28b6a02d7367f7c7c', 'admin', '2018-05-12 17:15:26', '2018-05-12 22:36:56', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(304, 'd917e2e18bb8caa969e9329972702bf6', 'admin', '2018-05-12 23:37:35', '2018-05-13 09:44:32', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(305, 'e2c527f4566e56f5252223fd748c7933', 'admin', '2018-05-13 09:44:43', '2018-05-14 17:19:57', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(306, 'fec55201514005d51e5bfe7611971f66', 'admin', '2018-05-14 17:20:21', '2018-05-15 18:04:09', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(307, 'bcd6c52c9fbe14e192bd4882106b8077', 'admin', '2018-05-15 18:04:20', '2018-05-15 18:46:23', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(308, '4d2a903df0639d5554c3a98da1aecd12', 'admin', '2018-05-15 18:46:23', '2018-05-16 16:00:36', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(309, '1bcb2ffc9ccd436021fb87813f15a31e', 'admin', '2018-05-16 16:06:00', '2018-05-16 21:24:21', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(310, '55f08548dc3441a615c2cec1c0a3434c', 'admin', '2018-05-17 15:17:30', '2018-05-17 21:43:01', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(311, '583fcbd2f23194499f0274dbed3ca7e4', 'admin', '2018-05-19 10:55:48', '2018-05-19 23:06:09', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(312, 'c272443901ef85be8cf3972c8f508c8e', 'admin', '2018-05-20 18:40:03', '2018-05-20 23:22:42', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1),
(313, 'e689a10527254eec2534c28b74b55ebe', 'admin', '2018-05-21 09:07:45', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Firefox/59.0', 1);
...
CREATE TABLE IF NOT EXISTS `stock` (
  ...
  `id_achat` int(11) DEFAULT NULL COMMENT 'Demande d''achat de l''article',
  `id_bl` int(11) DEFAULT NULL COMMENT 'BL qui a fait sortir l''article',
  `etat` int(11) DEFAULT '0',
  `creusr` int(11) DEFAULT NULL,
  `credat` datetime DEFAULT CURRENT_TIMESTAMP,
  `updusr` int(11) DEFAULT NULL,
...
INSERT INTO `stock` (`id`, `idproduit`, `qte`, `prix_achat`, `prix_vente`, `date_achat`, `date_validite`, `mouvement`, `id_achat`, `id_bl`, `etat`, `creusr`, `credat`, `updusr`, `upddat`) VALUES
(49, 22, 5, 150000, 200000, '2017-10-11', '2017-10-11', 'E', NULL, NULL, 0, 19, '2017-10-11 11:49:04', NULL, NULL),
(50, 22, 5, 100000, 150000, '2017-10-11', '2020-12-31', 'E', NULL, NULL, 0, 19, '2017-10-11 12:57:05', NULL, NULL),
(51, 23, 100, 850000, 1120000, '2017-10-16', '2017-10-16', 'E', NULL, NULL, 1, 1, '2017-10-16 22:38:31', 1, '2018-05-20 21:16:34'),
(52, 24, 5, 500000, 700000, '2017-10-17', '2017-10-17', 'E', NULL, NULL, 1, 24, '2017-10-17 14:33:25', 24, '2017-10-17 14:34:00'),
(53, 29, 120, 1000, 20000, '2018-03-04', '2018-03-29', 'E', NULL, NULL, 1, 1, '2018-03-04 01:17:18', 1, '2018-03-04 01:17:36'),
(54, 30, 20, 650000, 750000, '2018-03-04', '2022-12-31', 'E', NULL, NULL, 1, 1, '2018-03-04 13:00:02', 1, '2018-03-04 13:00:24'),
(56, 1, 1, 650000, 750000, '2018-03-04', '2022-12-31', 'E', NULL, NULL, 1, 1, '2018-03-04 13:00:02', 1, '2018-03-04 13:00:24'),
(83, 1, -1, NULL, NULL, NULL, NULL, 'S', NULL, 14, 0, NULL, '2018-05-17 15:36:32', NULL, NULL),
(84, 22, -3, NULL, NULL, NULL, NULL, 'S', NULL, 14, 0, NULL, '2018-05-17 15:36:32', NULL, NULL),
(85, 30, -5, NULL, NULL, NULL, NULL, 'S', NULL, 14, 0, NULL, '2018-05-17 15:36:32', NULL, NULL),
(86, 33, 20, 1000000, 1200000, '2018-05-19', '2018-11-30', 'E', NULL, NULL, 1, 1, '2018-05-19 14:08:06', 1, '2018-05-19 14:08:14'),
(87, 22, -7, NULL, NULL, NULL, NULL, 'S', NULL, 15, 0, NULL, '2018-05-19 12:16:32', NULL, NULL),
(88, 33, -5, NULL, NULL, NULL, NULL, 'S', NULL, 15, 0, NULL, '2018-05-19 12:16:32', NULL, NULL),
(90, 22, 10, 100000, 125000, '2018-05-19', '2018-05-20', 'E', NULL, NULL, 1, 1, '2018-05-19 14:42:08', 1, '2018-05-19 14:42:30'),
(91, 22, -10, NULL, NULL, NULL, NULL, 'S', NULL, 17, 0, NULL, '2018-05-19 12:50:14', NULL, NULL),
(92, 30, -10, NULL, NULL, NULL, NULL, 'S', NULL, 17, 0, NULL, '2018-05-19 12:50:14', NULL, NULL);

-- --------------------------------------------------------

--
-- Doublure de structure pour la vue `stock_actuel`
--
...
(553, 'Validation client #Devis:64', 'Update', 'devis', 64, 'admin', 'a23ea9f047832c84b5eba06942420bf5', '2018-05-07 00:15:51'),
(554, 'Enregistrement Détail Devis 231', 'Insert', 'd_devis', 231, 'admin', 'a23ea9f047832c84b5eba06942420bf5', '2018-05-07 00:17:05'),
(555, 'Enregistrement Devis 67', 'Insert', 'devis', 67, 'admin', 'a23ea9f047832c84b5eba06942420bf5', '2018-05-07 00:18:03'),
(556, 'Validation devis 67', 'Update', 'devis', 67, 'admin', 'a23ea9f047832c84b5eba06942420bf5', '2018-05-07 00:18:11'),
(557, 'Expédition devis 67', 'Update', 'devis', 67, 'admin', 'a23ea9f047832c84b5eba06942420bf5', '2018-05-07 00:18:16'),
(558, 'Validation client #Devis:67', 'Update', 'devis', 67, 'admin', 'a23ea9f047832c84b5eba06942420bf5', '2018-05-07 00:18:38'),
(559, 'Changement ETAT  bl', 'Update', 'bl', 3, 'admin', 'a23ea9f047832c84b5eba06942420bf5', '2018-05-07 00:21:41'),
(560, 'Changement ETAT  bl', 'Update', 'bl', 3, 'admin', 'a23ea9f047832c84b5eba06942420bf5', '2018-05-07 00:23:54'),
(561, 'Changement ETAT  bl', 'Update', 'bl', 2, 'admin', '95abeb5d07dd1c99e8867899eb129ece', '2018-05-08 22:28:18'),
(562, 'Insertion contrat abonnement', 'Insert', 'contrats', 103, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:05:44'),
(563, 'Validation contrat abonnement', 'Validate', 'contrats', 74, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:05:45'),
(564, 'Insertion échéance contrat abonnement', 'Insert', 'echeances_contrat', 141, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:05:45'),
(565, 'Insertion contrat abonnement', 'Insert', 'contrats', 104, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:11:21'),
(566, 'Validation contrat abonnement', 'Validate', 'contrats', 100, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:11:22'),
(567, 'Insertion échéance contrat abonnement', 'Insert', 'echeances_contrat', 142, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:11:22'),
(568, 'Insertion échéance contrat abonnement', 'Insert', 'echeances_contrat', 143, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:11:22'),
(569, 'Insertion échéance contrat abonnement', 'Insert', 'echeances_contrat', 144, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:11:22'),
(570, 'Insertion échéance contrat abonnement', 'Insert', 'echeances_contrat', 145, 'admin', '7a4b74890277f5d28b6a02d7367f7c7c', '2018-05-12 21:11:22'),
(571, 'Changement ETAT  entrepots', 'Update', 'entrepots', 1, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 09:45:42'),
(572, 'Modification Entrepôt', 'Update', 'entrepots', 1, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 09:45:51'),
(573, 'Validation produit', 'Validate', 'produits', 1, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 09:46:14'),
(574, 'Validation produit', 'Validate', 'produits', 1, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 09:47:22'),
(575, 'Validation produit', 'Validate', 'produits', 1, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 09:47:38'),
(576, 'Changement ETAT  entrepots', 'Update', 'entrepots', 1, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 09:47:44'),
(577, 'Modification produit', 'Update', 'produits', 1, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 09:48:04'),
(578, 'Validation produit', 'Validate', 'produits', 1, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 09:48:10'),
(579, 'Validation client #Devis:67', 'Update', 'devis', 67, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 15:54:03'),
(580, 'Changement ETAT  bl', 'Update', 'bl', 2, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 19:53:53'),
(581, 'Changement ETAT  bl', 'Update', 'bl', 8, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 20:41:40'),
(582, 'Changement ETAT  bl', 'Update', 'bl', 8, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 20:45:59'),
(583, 'Changement ETAT  bl', 'Update', 'bl', 8, 'admin', 'e2c527f4566e56f5252223fd748c7933', '2018-05-13 20:47:57'),
(584, 'Changement ETAT  bl', 'Update', 'bl', 8, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 17:33:20'),
(585, 'Changement ETAT  bl', 'Update', 'bl', 8, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 17:39:31'),
(586, 'Changement ETAT  bl', 'Update', 'bl', 8, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 17:51:43'),
(587, 'Changement ETAT  bl', 'Update', 'bl', 8, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 17:54:38'),
(588, 'Insertion contrat abonnement', 'Insert', 'contrats', 105, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:34:32'),
(589, 'Validation contrat abonnement', 'Validate', 'contrats', 75, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:34:33'),
(590, 'Insertion échéance contrat abonnement', 'Insert', 'echeances_contrat', 146, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:34:33'),
(591, 'Insertion échéance contrat abonnement', 'Insert', 'echeances_contrat', 147, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:34:33'),
(592, 'Enregistrement Détail Devis 232', 'Insert', 'd_devis', 232, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:52:18'),
(593, 'Enregistrement Détail Devis 233', 'Insert', 'd_devis', 233, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:52:27'),
(594, 'Enregistrement Devis 68', 'Insert', 'devis', 68, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:52:42'),
(595, 'Validation devis 68', 'Update', 'devis', 68, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:55:46'),
(596, 'Expédition devis 68', 'Update', 'devis', 68, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:55:54'),
(597, 'Validation client #Devis:68', 'Update', 'devis', 68, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 18:56:58'),
(598, 'Changement ETAT  bl', 'Update', 'bl', 9, 'admin', 'fec55201514005d51e5bfe7611971f66', '2018-05-14 21:50:24'),
(599, 'Enregistrement Détail Devis 234', 'Insert', 'd_devis', 234, 'admin', '4d2a903df0639d5554c3a98da1aecd12', '2018-05-15 19:55:54'),
(600, 'Enregistrement Détail Devis 235', 'Insert', 'd_devis', 235, 'admin', '4d2a903df0639d5554c3a98da1aecd12', '2018-05-15 19:56:59'),
(601, 'Enregistrement Devis 69', 'Insert', 'devis', 69, 'admin', '4d2a903df0639d5554c3a98da1aecd12', '2018-05-15 19:57:22'),
(602, 'Validation devis 69', 'Update', 'devis', 69, 'admin', '4d2a903df0639d5554c3a98da1aecd12', '2018-05-15 19:58:03'),
(603, 'Expédition devis 69', 'Update', 'devis', 69, 'admin', '4d2a903df0639d5554c3a98da1aecd12', '2018-05-15 19:58:11'),
(604, 'Validation client #Devis:69', 'Update', 'devis', 69, 'admin', '4d2a903df0639d5554c3a98da1aecd12', '2018-05-15 19:58:29'),
(605, 'Validation client #Devis:69', 'Update', 'devis', 69, 'admin', '4d2a903df0639d5554c3a98da1aecd12', '2018-05-15 20:03:09'),
(606, 'Changement ETAT  bl', 'Update', 'bl', 11, 'admin', '4d2a903df0639d5554c3a98da1aecd12', '2018-05-15 20:05:35'),
(607, 'Enregistrement Détail Devis 236', 'Insert', 'd_devis', 236, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:11:51'),
(608, 'Enregistrement Détail Devis 237', 'Insert', 'd_devis', 237, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:12:15'),
(609, 'Enregistrement Détail Devis 238', 'Insert', 'd_devis', 238, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:12:43'),
(610, 'Enregistrement Devis 70', 'Insert', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:12:55'),
(611, 'Validation devis 70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:14:02'),
(612, 'Expédition devis 70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:14:15'),
(613, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:14:36'),
(614, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:14:44'),
(615, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:15:03'),
(616, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:15:10'),
(617, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:15:46'),
(618, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:23:48'),
(619, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:29:13'),
(620, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:30:38'),
(621, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:42:27'),
(622, 'Validation client #Devis:70', 'Update', 'devis', 70, 'admin', '1bcb2ffc9ccd436021fb87813f15a31e', '2018-05-16 17:42:53'),
(623, 'Enregistrement Détail Devis 239', 'Insert', 'd_devis', 239, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:22:21'),
(624, 'Enregistrement Détail Devis 240', 'Insert', 'd_devis', 240, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:23:08'),
(625, 'Enregistrement Détail Devis 241', 'Insert', 'd_devis', 241, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:25:30'),
(626, 'Enregistrement Devis 71', 'Insert', 'devis', 71, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:25:46'),
(627, 'Validation devis 71', 'Update', 'devis', 71, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:27:44'),
(628, 'Expédition devis 71', 'Update', 'devis', 71, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:27:58'),
(629, 'Validation client #Devis:71', 'Update', 'devis', 71, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:32:54'),
(630, 'Validation client #Devis:71', 'Update', 'devis', 71, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:32:57'),
(631, 'Validation client #Devis:71', 'Update', 'devis', 71, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:36:05'),
(632, 'Changement ETAT  bl', 'Update', 'bl', 14, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 15:36:32'),
(633, 'Validation client #Devis:68', 'Update', 'devis', 68, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 16:21:31'),
(634, 'Validation client #Devis:68', 'Update', 'devis', 68, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 16:21:40'),
(635, 'Validation client #Devis:68', 'Update', 'devis', 68, 'admin', '55f08548dc3441a615c2cec1c0a3434c', '2018-05-17 16:42:14'),
(636, 'Création Entrepôt', 'Insert', 'entrepots', 2, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 11:45:12'),
(637, 'Modification Entrepôt', 'Update', 'entrepots', 1, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:04:01'),
(638, 'Changement ETAT  entrepots', 'Update', 'entrepots', 2, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:04:10'),
(639, 'Insertion produit', 'Insert', 'produits', 33, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:05:03'),
(640, 'Validation produit', 'Validate', 'produits', 33, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:05:22'),
(641, 'Insertion achat produit', 'Insert', 'stock', 86, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:08:06'),
(642, 'Validation achat produit', 'Validate', 'stock', 86, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:08:14'),
(643, 'Enregistrement Détail Devis 242', 'Insert', 'd_devis', 242, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:08:57'),
(644, 'Enregistrement Détail Devis 243', 'Insert', 'd_devis', 243, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:09:39'),
(645, 'Enregistrement Devis 72', 'Insert', 'devis', 72, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:09:55'),
(646, 'Validation devis 72', 'Update', 'devis', 72, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:10:02'),
(647, 'Expédition devis 72', 'Update', 'devis', 72, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:10:08'),
(648, 'Validation client #Devis:72', 'Update', 'devis', 72, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:11:02'),
(649, 'Validation client #Devis:72', 'Update', 'devis', 72, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:12:12'),
(650, 'Changement ETAT  bl', 'Update', 'bl', 15, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:16:32'),
(651, 'Enregistrement Détail Devis 244', 'Insert', 'd_devis', 244, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:32:55'),
(652, 'Enregistrement Détail Devis 245', 'Insert', 'd_devis', 245, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:33:52'),
(653, 'Enregistrement Devis 73', 'Insert', 'devis', 73, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:34:10'),
(654, 'Validation devis 73', 'Update', 'devis', 73, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:35:14'),
(655, 'Expédition devis 73', 'Update', 'devis', 73, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:35:29'),
(656, 'Validation client #Devis:73', 'Update', 'devis', 73, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:35:53'),
(657, 'Insertion achat produit', 'Insert', 'stock', 90, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:42:08'),
(658, 'Validation achat produit', 'Validate', 'stock', 90, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:42:30'),
(659, 'Enregistrement Détail Devis 246', 'Insert', 'd_devis', 246, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:45:18'),
(660, 'Enregistrement Devis 74', 'Insert', 'devis', 74, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:45:23'),
(661, 'Validation devis 74', 'Update', 'devis', 74, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:45:29'),
(662, 'Expédition devis 74', 'Update', 'devis', 74, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:45:39'),
(663, 'Validation client #Devis:74', 'Update', 'devis', 74, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:45:47'),
(664, 'Validation client #Devis:73', 'Update', 'devis', 73, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:48:59'),
(665, 'Changement ETAT  bl', 'Update', 'bl', 17, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 12:50:14'),
(666, 'Validation produit', 'Validate', 'produits', 1, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 14:05:30'),
(667, 'Validation produit', 'Validate', 'produits', 1, 'admin', '583fcbd2f23194499f0274dbed3ca7e4', '2018-05-19 14:06:10'),
(668, 'Validation achat produit', 'Validate', 'stock', 51, 'admin', 'c272443901ef85be8cf3972c8f508c8e', '2018-05-20 19:10:54'),
(669, 'Validation achat produit', 'Validate', 'stock', 51, 'admin', 'c272443901ef85be8cf3972c8f508c8e', '2018-05-20 19:11:50'),
(670, 'Validation achat produit', 'Validate', 'stock', 51, 'admin', 'c272443901ef85be8cf3972c8f508c8e', '2018-05-20 19:16:34');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table des notification app' AUTO_INCREMENT=23 ;
...
(16, 'etat_devis', '{"creat_devis":"0", "valid_devis":"1", "send_devis":"2", "modif_client": "3", "valid_client":"4","en_livre":"8", "refus_client":"5", "devis_expir":"6", "devis_archive":"7"}', 'Etat WF devis', 144, 1, '1', '2018-05-16 19:33:32', NULL, NULL);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table Task of modules' AUTO_INCREMENT=902 ;
...
(879, 'bl', 142, 'bl', 'vente/submodul/bl', 1, 'Gestion BL', 'bookmark-o', 1, 0, 0, 'list', '[-1-2-3-5-4-]'),
(880, 'validbl', 142, 'validbl', 'vente/submodul/bl', 1, 'Valider BL', 'check green', 1, 0, 0, 'exec', '[-1-2-3-5-4-]'),
(881, 'detailbl', 142, 'detailbl', 'vente/submodul/bl', 1, 'Détail BL', 'eye blue', 1, 0, 0, 'profil', '[-1-2-3-5-4-]'),
(886, 'stock_actuel', 143, 'stock_actuel', 'stock/submodul/stock_actuel', 1, 'Stock Actuel', 'external-link', 1, 0, 0, 'list', '[-1-2-3-5-]'),
(887, 'editbl', 142, 'editbl', 'vente/submodul/bl', 1, 'Editer BL', 'pencil', 1, 0, 0, 'formedit', '[-1-2-3-5-4-]'),
(888, 'devis', 144, 'devis', 'vente/submodul/devis', 1, 'Gestion Devis', 'paper-plane-o', 1, 0, 0, 'list', '[-1-2-]'),
(889, 'adddevis', 144, 'adddevis', 'vente/submodul/devis', 1, 'Ajouter Devis', 'plus', 1, 0, 0, 'form', '[-1-2-]'),
(890, 'add_detaildevis', 144, 'add_detaildevis', 'vente/submodul/devis', 1, 'Ajouter détail devis', 'plus', 1, 0, 0, 'form', '[-1-2-]'),
(891, 'editdevis', 144, 'editdevis', 'vente/submodul/devis', 1, 'Modifier Devis', 'pen', 1, 0, 0, 'form', '[-1-2-]'),
(892, 'deletedevis', 144, 'deletedevis', 'vente/submodul/devis', 1, 'Supprimer Devis', 'trash red', 1, 0, 0, 'exec', '[-1-2-]'),
(893, 'edit_detaildevis', 144, 'edit_detaildevis', 'vente/submodul/devis', 1, 'Modifier détail Devis', 'pen', 1, 0, 0, 'form', '[-1-2-]'),
(894, 'viewdevis', 144, 'viewdevis', 'vente/submodul/devis', 1, 'Afficher détail devis', 'eye', 1, 0, 0, 'profil', '[-1-2-]'),
(895, 'validdevis', 144, 'validdevis', 'vente/submodul/devis', 1, 'Valider Devis', NULL, 1, 0, 0, 'exec', '[-1-2-]'),
(896, 'validdevisclient', 144, 'validdevisclient', 'vente/submodul/devis', 1, 'Validation Client Devis', 'check', 1, 0, 0, 'formpers', '[-1-2-]'),
(897, 'debloqdevis', 144, 'debloqdevis', 'vente/submodul/devis', 1, 'Débloquer devis', 'unlock blue', 1, 0, 0, 'exec', '[-1-2-]'),
(898, 'archivdevis', 144, 'archivdevis', 'vente/submodul/devis', 1, 'Archiver Devis', 'zip', 1, 0, 0, 'exec', '[-1-2-3-]'),
(899, 'add_client_diver', 144, 'add_client_diver', 'vente/submodul/devis', 1, 'Ajout client divers', 'plus', 1, 0, 0, 'formadd', '[-1-2-3-]'),
(900, 'renewdevis', 144, 'renewdevis', 'vente/submodul/devis', 1, 'Renouveler Devis', 'share', 1, 0, 0, 'formedit', '[-1-2-3-]'),
(901, 'devislivraison', 144, 'devislivraison', 'vente/submodul/devis', 1, 'Préparer livraison', 'external-link', 1, 0, 0, 'formpers', '[-1-2-3-]');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table of Task_Action and Permission of Task' AUTO_INCREMENT=1490 ;
...
(1151, 728, '192715027870a4a612fd44d562e2752f', 'Gestion des produits', NULL, 'produits', NULL, '', 0, '[-1-]', 0, 0, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1152, 728, 'cb96e99d5f8e381637d1ac83f1a21f1c', 'Modifier  produit', 'this_url', 'editproduit', 'pencil-square-o', '<li><a href="#" class="this_url" data="%id%" rel="editproduit"  ><i class="ace-icon fa fa-pencil-square-o bigger-100"></i> Modifier  produit</a></li>', 0, '[-1-]', 0, 0, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1153, 728, 'b616f14591eb44cc874785f03963ae34', 'Détail  produit', 'this_url', 'detailproduit', 'eye', '<li><a href="#" class="this_url" data="%id%" rel="detailproduit"  ><i class="ace-icon fa fa-eye bigger-100"></i> Détail  produit</a></li>', 0, '[-1-]', 0, 0, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1154, 728, '0c94d85f4ee23656a01155ad1af5001c', 'Valider  produit', 'this_exec', 'validproduit', 'check-square-o', '<li><a href="#" class="this_exec" data="%id%" rel="validproduit"  ><i class="ace-icon fa fa-check-square-o bigger-100"></i> Valider  produit</a></li>', 0, '[-1-]', 0, 1, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1155, 728, '6b087b20929483bb07f8862b39e41f07', 'Désactiver produit', 'this_exec', 'validproduit', NULL, '<li><a href="#" class="this_exec" data="%id%" rel="validproduit"  ><i class="ace-icon fa fa-cogs bigger-100"></i> Désactiver produit</a></li>', 0, '[-1-]', 1, 0, 'En Stock', 'success', '<span class="label label-sm label-success">En Stock</span>', NULL, NULL, NULL, NULL),
(1156, 728, '68c9513decd1228ca1dc406ab4f28bbd', 'Achat  produit', 'this_url', 'buyproducts', 'euro', '<li><a href="#" class="this_url" data="%id%" rel="buyproducts"  ><i class="ace-icon fa fa-euro bigger-100"></i> Achat  produit</a></li>', 0, '[-1-]', 1, 0, 'En Stock', 'success', '<span class="label label-sm label-success">En Stock</span>', NULL, NULL, NULL, NULL),
(1157, 728, '41b9c4b7028269d4540915d6ec14ee79', 'Détails Produit', 'this_url', 'detailproduit', NULL, '<li><a href="#" class="this_url" data="%id%" rel="detailproduit"  ><i class="ace-icon fa fa-eye bigger-100"></i> Détails Produit</a></li>', 0, '[-1-]', 1, 0, 'En Stock', 'success', '<span class="label label-sm label-success">En Stock</span>', NULL, NULL, NULL, NULL),
...
(1442, 879, '29d3ba7d2ceccd9ee362a8c546946cad', 'Gestion BL', NULL, 'bl', NULL, '', 1, '[-1-2-3-5-4-]', 0, 0, 'Attente validation', 'warning', '<span class="label label-sm label-warning">Attente validation</span>', NULL, NULL, NULL, NULL),
(1443, 879, 'aa39ac5e6ba2805784c71acf92030e0f', 'Valider BL', 'this_exec', 'validbl', NULL, '<li><a href="#" class="this_exec" data="%id%" rel="validbl"  ><i class="ace-icon fa fa-check green bigger-100"></i> Valider BL</a></li>', 0, '[-1-2-3-5-]', 0, 1, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1444, 879, 'a0e04a27854b1fc0587dbb818f9264d9', 'Détails BL     ', 'this_url', 'detailbl', 'eye', '<li><a href="#" class="this_url" data="%id%" rel="detailbl"  ><i class="ace-icon fa fa-eye bigger-100"></i> Détails BL     </a></li>', 0, '[-1-2-3-5-]', 0, 0, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1445, 880, '0a8c8609ecb28b5ccbce6d7910d791fc', 'Valider BL', NULL, 'validbl', NULL, '', 1, '[-1-2-3-]', 0, 0, 'Attente validation', 'warning', '<span class="label label-sm label-warning">Attente validation</span>', NULL, NULL, NULL, NULL),
(1446, 881, 'cc8d69937778bdaa2240c40a229571ba', 'Détail BL', NULL, 'detailbl', NULL, '', 1, '[-1-2-3-5-]', 0, 0, 'Attente validation', 'warning', '<span class="label label-sm label-warning">Attente validation</span>', NULL, NULL, NULL, NULL),
(1447, 879, 'cbc30164dd9987eabab0deca93fa13ae', 'Détails BL', 'this_url', 'detailbl', 'eye', '<li><a href="#" class="this_url" data="%id%" rel="detailbl"  ><i class="ace-icon fa fa-eye bigger-100"></i> Détails BL</a></li>', 0, '[-1-2-3-5-]', 1, 0, 'Facture Générée', 'success', '<span class="label label-sm label-success">Facture Générée</span>', NULL, NULL, NULL, NULL),
(1456, 886, 'c88249c68efc019ecd2ba5a245337841', 'Stock Actuel', NULL, 'stock_actuel', '886', '', 1, '[-1-2-3-5-]', 0, 0, 'Stock Actuel', 'success', '<span class="label label-sm label-success">Stock Actuel</span>', NULL, NULL, NULL, NULL),
(1457, 887, 'b50607b922c3082698c6e5c388a1b2e2', 'Editer BL', NULL, 'editbl', '887', '', 1, '[-1-2-3-5-]', 0, 0, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1458, 879, '02aebc37c7e38faea780fc8c11ee7fdc', 'Editer BL', 'this_url', 'editbl', 'pencil', '<li><a href="#" class="this_url" data="%id%" rel="editbl"  ><i class="ace-icon fa fa-pencil bigger-100"></i> Editer BL</a></li>', 0, '[-1-2-3-5-]', 0, 0, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1459, 888, '0e79510db7f03b9b6266fc7b4a612153', 'Gestion Devis', NULL, 'devis', NULL, '', 1, '[-1-2-]', 0, 1, 'Attente validation', 'warning', '<span class="label label-sm label-warning">Attente validation</span>', NULL, NULL, NULL, NULL),
(1460, 888, 'c15b00a1e37657336df8b6aa0eea2db5', 'Modifier Devis', 'this_url', 'editdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="editdevis"  ><i class="ace-icon fa fa-pencil-square-o blue bigger-100"></i> Modifier Devis</a></li>', 0, '[-1-2-]', 0, 0, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1461, 888, '7cfdba6bc6bc94c65b97e77746cf49b5', 'Envoi au client', 'this_exec', 'validdevis', NULL, '<li><a href="#" class="this_exec" data="%id%" rel="validdevis"  ><i class="ace-icon fa fa-envelope bigger-100"></i> Envoi au client</a></li>', 0, '[-1-2-3-]', 1, 1, 'Attente Expédition', 'warning', '<span class="label label-sm label-warning">Attente Expédition</span>', NULL, NULL, NULL, NULL),
(1462, 888, '28e267a2a0647d4cb37b18abb1e7d051', 'Voir détails', 'this_url', 'viewdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="viewdevis"  ><i class="ace-icon fa fa-eye bigger-100"></i> Voir détails</a></li>', 0, '[-1-2-3-5-]', 1, 1, 'Attente Expédition', 'warning', '<span class="label label-sm label-warning">Attente Expédition</span>', NULL, NULL, NULL, NULL),
(1463, 888, 'd34b07afd92adad84e1c4c2ebd92ba95', 'Voir détails', 'this_url', 'viewdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="viewdevis"  ><i class="ace-icon fa fa-eye blue bigger-100"></i> Voir détails</a></li>', 0, '[-3-5-]', 0, 0, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1464, 888, 'f6f55b9d0ba9d704b2861d57cda32477', 'Réponse Client', 'this_url', 'validdevisclient', NULL, '<li><a href="#" class="this_url" data="%id%" rel="validdevisclient"  ><i class="ace-icon fa fa-check green bigger-100"></i> Réponse Client</a></li>', 0, '[-1-2-3-5-]', 2, 0, 'Attente réponse client', 'info', '<span class="label label-sm label-info">Attente réponse client</span>', NULL, NULL, NULL, NULL),
(1465, 888, '4b11c0bfb3f970a541100f7fc334927e', 'Voir détails', 'this_url', 'viewdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="viewdevis"  ><i class="ace-icon fa fa-eye bigger-100"></i> Voir détails</a></li>', 0, '[-1-2-3-5-]', 3, 1, 'Demande modification', 'info', '<span class="label label-sm label-info">Demande modification</span>', NULL, NULL, NULL, NULL),
(1466, 888, '61a0655c2c13039b5b8262b82ae6cb51', 'Voir détails', 'this_url', 'viewdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="viewdevis"  ><i class="ace-icon fa fa-eye bigger-100"></i> Voir détails</a></li>', 0, '[-1-2-3-5-]', 2, 0, 'Attente réponse client', 'info', '<span class="label label-sm label-info">Attente réponse client</span>', NULL, NULL, NULL, NULL),
(1467, 888, 'ed30dfbb21d8d24a0da432252358bdf8', 'Voir détails', 'this_url', 'viewdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="viewdevis"  ><i class="ace-icon fa fa-eye bigger-100"></i> Voir détails</a></li>', 0, '[-1-2-3-5-]', 4, 0, 'Devis Validé par le client', 'success', '<span class="label label-sm label-success">Devis Validé par le client</span>', NULL, NULL, NULL, NULL),
(1468, 888, '7bd2e025ffb3893dea4776e152301716', 'Débloquer devis', 'this_exec', 'debloqdevis', NULL, '<li><a href="#" class="this_exec" data="%id%" rel="debloqdevis"  ><i class="ace-icon fa fa-unlock blue bigger-100"></i> Débloquer devis</a></li>', 0, '[-1-3-]', 3, 1, 'Demande modification', 'info', '<span class="label label-sm label-info">Demande modification</span>', NULL, NULL, NULL, NULL),
(1469, 888, '6d9ec7d9ebebcdc921376e7bf0c9fdaf', 'Valider devis', 'this_exec', 'validdevis', NULL, '<li><a href="#" class="this_exec" data="%id%" rel="validdevis"  ><i class="ace-icon fa fa-check green bigger-100"></i> Valider devis</a></li>', 0, '[-1-3-]', 0, 1, 'Attente Validation', 'warning', '<span class="label label-sm label-warning">Attente Validation</span>', NULL, NULL, NULL, NULL),
(1470, 888, 'b1bcc4a4ab154f110abcf54c0c659fb3', 'Voir détails', 'this_url', 'viewdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="viewdevis"  ><i class="ace-icon fa fa-eye bigger-100"></i> Voir détails</a></li>', 0, '[-1-2-3-5-]', 5, 0, 'Devis rejeté par le client', 'danger', '<span class="label label-sm label-danger">Devis rejeté par le client</span>', NULL, NULL, NULL, NULL),
(1471, 888, '91a90a46e3430c491ab8db654b6e87c4', 'Voir détails', 'this_url', 'viewdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="viewdevis"  ><i class="ace-icon fa fa-eye bigger-100"></i> Voir détails</a></li>', 0, '[-1-2-3-5-]', 6, 0, 'Devis Expiré', 'inverse', '<span class="label label-sm label-inverse">Devis Expiré</span>', NULL, NULL, NULL, NULL),
(1472, 888, 'cf6178eae84de71449fcee8911b77f40', 'Renouveler Devis', 'this_exec', 'renewdevis', NULL, '<li><a href="#" class="this_exec" data="%id%" rel="renewdevis"  ><i class="ace-icon fa fa-share bigger-100"></i> Renouveler Devis</a></li>', 0, '[-1-2-3-]', 6, 0, 'Devis Expiré', 'inverse', '<span class="label label-sm label-inverse">Devis Expiré</span>', NULL, NULL, NULL, NULL),
(1473, 888, 'c0c64bb86ef45f064af45136b5f28ae7', 'Voir détails', 'this_url', 'viewdevis', NULL, '<li><a href="#" class="this_url" data="%id%" rel="viewdevis"  ><i class="ace-icon fa fa-eye bigger-100"></i> Voir détails</a></li>', 0, '[-1-2-3-5-]', 8, 1, 'En Livraison', 'info', '<span class="label label-sm label-info">En Livraison</span>', NULL, NULL, NULL, NULL),
(1474, 888, '18f2ec7bc883829e215136a2318755ef', 'Préparer livraison', 'this_url', 'devislivraison', NULL, '<li><a href="#" class="this_url" data="%id%" rel="devislivraison"  ><i class="ace-icon fa fa-external-link  bigger-100"></i> Préparer livraison</a></li>', 0, '[-1-2-3-5-]', 8, 1, 'En Livraison', 'info', '<span class="label label-sm label-info">En Livraison</span>', NULL, NULL, NULL, NULL),
(1475, 889, 'd9eeb330625c1b87e0df00986a47be01', 'Ajouter Devis', NULL, 'adddevis', NULL, '', 0, '[-1-2-]', 0, 0, 'Brouillon', 'success', '<span class="label label-sm label-success">Brouillon</span>', NULL, NULL, NULL, NULL),
(1476, 890, 'da93cdb05137e15aed9c4c18bddd746a', 'Ajouter détail devis', NULL, 'add_detaildevis', NULL, '', 0, '[-1-2-]', 0, 0, 'Attente validation', 'success', '<span class="label label-sm label-success">Attente validation</span>', NULL, NULL, NULL, NULL),
(1477, 891, 'f9f3c299f9bd0fec014f6bd3f0e06adb', 'Modifier Devis', NULL, 'editdevis', NULL, '', 0, '[-1-2-]', 0, 0, 'Attente validation', 'warning', '<span class="label label-sm label-warning">Attente validation</span>', NULL, NULL, NULL, NULL),
(1478, 892, 'e14cce6f1faf7784adb327581c516b90', 'Supprimer Devis', NULL, 'deletedevis', NULL, '', 0, '[-1-3-]', 0, 0, 'Attente validation', 'warning', '<span class="label label-sm label-warning">Attente validation</span>', NULL, NULL, NULL, NULL),
(1479, 893, '38f10871792c133ebcc6040e9a11cde8', 'Modifier détail Devis', NULL, 'edit_detaildevis', NULL, '', 0, '[-1-2-3-]', 0, 0, 'Attente validation', 'warning', '<span class="label label-sm label-warning">Attente validation</span>', NULL, NULL, NULL, NULL),
(1480, 894, '8def42e75fd4aee61c378d9fb303850d', 'Afficher détail devis', NULL, 'viewdevis', NULL, '', 0, '[-1-2-3-4-18-]', 0, 0, 'Attente de validation', 'warning', '<span class="label label-sm label-warning">Attente de validation</span>', NULL, NULL, NULL, NULL),
(1481, 895, '7666e87783b0f5a7eec1eea7593f7dfe', 'Valider Devis', NULL, 'validdevis', NULL, '', 0, '[-1-2-3-5-4-]', 0, 0, 'Attente validation', 'success', '<span class="label label-sm label-success">Attente validation</span>', NULL, NULL, NULL, NULL),
(1482, 896, '7f1c48324d8c369da9aa6ab8af35acd8', 'Validation Client Devis', NULL, 'validdevisclient', NULL, '', 0, '[-1-2-3-5-]', 0, 0, 'Attente validation client', 'info', '<span class="label label-sm label-info">Attente validation client</span>', NULL, NULL, NULL, NULL),
(1483, 897, '6adf896091dde0df89f777f31606953c', 'Débloquer devis', NULL, 'debloqdevis', NULL, '', 0, '[-1-3-]', 0, 0, 'Débloquer Devis', 'inverse', '<span class="label label-sm label-inverse">Débloquer Devis</span>', NULL, NULL, NULL, NULL),
(1484, 898, '15cbb79dd4a74266158e6b29a83e683c', 'Archiver Devis', NULL, 'archivdevis', NULL, '', 1, '[-1-3-]', 0, 0, 'Devis archivé', 'inverse', '<span class="label label-sm label-inverse">Devis archivé</span>', NULL, NULL, NULL, NULL),
(1485, 899, 'f520c1e87674cdaf83635d37863de930', 'Ajout client divers', NULL, 'add_client_diver', NULL, '', 1, '[-1-2-3-]', 0, 0, 'Attente validation', 'success', '<span class="label label-sm label-success">Attente validation</span>', NULL, NULL, NULL, NULL),
(1486, 900, '118fe4b340e728b2cb9ee9607531fae4', 'Renouveler Devis', NULL, 'renewdevis', NULL, '', 1, '[-1-2-3-]', 0, 0, 'Devis expiré', 'inverse', '<span class="label label-sm label-inverse">Devis expiré</span>', NULL, NULL, NULL, NULL),
(1487, 901, '9a405d89d749c15a976b939b96a1128b', 'Préparer livraison', NULL, 'devislivraison', NULL, '', 1, '[-1-2-3-5-]', 0, 0, 'En Livraison', 'info', '<span class="label label-sm label-info">En Livraison</span>', NULL, NULL, NULL, NULL),
(1488, 728, '5af94daa3128b843b812f150bc553947', 'Achat  produit', 'this_url', 'buyproducts', 'euro', '<li><a href="#" class="this_url" data="%id%" rel="buyproducts"  ><i class="ace-icon fa fa-euro bigger-100"></i> Achat  produit</a></li>', 0, '[-1-]', 2, 1, 'Stock Minimum', 'warning', '<span class="label label-sm label-warning">Stock Minimum</span>', NULL, NULL, NULL, NULL),
(1489, 728, '2c3dc91d46bda8401471d8107103246a', 'Détails Produit', 'this_url', 'detailproduit', 'eye', '<li><a href="#" class="this_url" data="%id%" rel="detailproduit"  ><i class="ace-icon fa fa-eye bigger-100"></i> Détails Produit</a></li>', 0, '[-1-]', 2, 0, 'Stock Minimum', 'warning', '<span class="label label-sm label-warning">Stock Minimum</span>', NULL, NULL, NULL, NULL);
...
(1, 'admin', 'Administrateur', 'Systeme', '5a05679021426829ab75ac9fa6655947', 'rachid@atelsolution.com', 1, '6544545454', 1, 0, 1, 0, '2018-05-21 10:12:42', 1, 2, 9, NULL, '2017-01-13 13:52:42', '1', '2017-06-06 19:22:54'),
...
--
-- Structure de la vue `mouvements_stock`
--
DROP TABLE IF EXISTS `mouvements_stock`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `mouvements_stock` AS (select `s`.`id` AS `id`,`e`.`libelle` AS `entrepot`,`p`.`id` AS `id_produit`,`p`.`reference` AS `reference`,`p`.`designation` AS `designation`,`p`.`stock_min` AS `seuil`,if((`s`.`mouvement` = 'E'),'Entrée',if((`s`.`mouvement` = 'S'),'Sortie',' ')) AS `mouvement`,if((`s`.`mouvement` = 'E'),`s`.`qte`,if((`s`.`mouvement` = 'S'),`s`.`qte`,' ')) AS `qte`,cast(`s`.`credat` as date) AS `DATE`,if((`s`.`mouvement` = 'E'),' ',if((`s`.`mouvement` = 'S'),(select concat(`bl`.`reference`,' - ',`c`.`denomination`) from ((`bl` join `devis` `d`) join `clients` `c`) where ((`bl`.`id` = `s`.`id_bl`) and (`bl`.`iddevis` = `d`.`id`) and (`d`.`id_client` = `c`.`id`))),' ')) AS `source`,`q`.`qte_act` AS `qte_stock` from (((`produits` `p` join `stock` `s`) join `entrepots` `e`) join `qte_actuel` `q`) where ((`p`.`id` = `s`.`idproduit`) and (`e`.`id` = `p`.`id_entrepot`) and (`p`.`id` = `q`.`id_produit`)));
...
--
-- Structure de la vue `stock_actuel`
--
DROP TABLE IF EXISTS `stock_actuel`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `stock_actuel` AS (select `e`.`libelle` AS `entrepot`,`p`.`id` AS `id_produit`,`p`.`reference` AS `reference`,`p`.`designation` AS `designation`,`p`.`stock_min` AS `seuil`,(select `q`.`qte_act` from `qte_actuel` `q` where (`p`.`id` = `q`.`id_produit`)) AS `qte_stock` from (`produits` `p` join `entrepots` `e`) where (`e`.`id` = `p`.`id_entrepot`) group by `p`.`id`);
...
--
ALTER TABLE `stock`
  ADD CONSTRAINT `fk_bl` FOREIGN KEY (`id_bl`) REFERENCES `bl` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_produit` FOREIGN KEY (`idproduit`) REFERENCES `produits` (`id`) ON UPDATE CASCADE;
