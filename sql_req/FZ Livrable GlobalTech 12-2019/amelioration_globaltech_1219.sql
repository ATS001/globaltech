--Global Tel et Tech:
--*********************************************************************
--Ajout de id_devise dans devis et facture
...
---------------------------------------------------------------------
-- 
-- Structure de la table `ste_info_banque`
-- 
...
--------------------------------------------------------------------------
--
-- Structure de la table `sys_taux_change`
--
...
-- --------------------------------------------------------
ALTER TABLE encaissements ADD montant_devise_ext INT NULL AFTER depositaire;

-- --------------------------------------------------------

------------Procédure -------------------------------------------

DROP PROCEDURE generate_fact
