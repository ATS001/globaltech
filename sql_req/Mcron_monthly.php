...
$terminison_file = '_job_cron_month.php';
...
{
	$file = MPATH_INCLUDES.SLASH.'log_cron_monthly.log';
	$line = '['.date('d-m-Y H:i:s').']: '.$log.' =>'.MPATH_CRON_JOB.$current_job.'_cron_job_month.php'.PHP_EOL;
