...
//Created : 25-04-2018
//Controller ADD Form
if(MInit::form_verif('addentrepots', false))
{
...
'date_creation'         => Mreq::tp('date_creation') ,
	...
	if($posted_data["date_creation"] == NULL){
       ...
       //End check empty element
		$new_entrepots = new  Mentrepots($posted_data);



        //execute Insert returne false if error
		if($new_entrepots->save_new_entrepots()){

			exit("1#".$new_entrepots->log);
		}else{

			exit("0#".$new_entrepots->log);
		}
