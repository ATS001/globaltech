...
$form = new Mform('addinstallateur_ph', 'addinstallateur_ph', '', 'installateurs', '1');
...
//image
$form->input('Photo de l\'installateur', 'pj_image', 'file', 6, null, null);
$form->file_js('pj_image', 1000000, 'image');

//Dénomination
$denomination_array[]  = array('required', 'true', 'Insérer le Nom et le Prénom Installateur' );
$denomination_array[]  = array('remote', 'denomination#installateurs#denomination', 'Ce Nom et Prénom existe déja' );
$form->input('Nom & Prénom', 'denomination', 'text' ,9 , null, $denomination_array);
...
$form->input('CIN', 'piece_identite', 'text' ,9 , null, $piece_identite_array);
...
$form->input('Qualification de l\'installateur', 'qualification', 'text', 9, null, $qualification_array);
