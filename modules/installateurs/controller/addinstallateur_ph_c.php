<?php
if(MInit::form_verif('addinstallateur_ph', false))
{
    $posted_data = array(
   'type_instal'    => 'PHYSIQUE',
  ...
  /*if($posted_data['type_instal'] == NULL){
    ...
    $empty_list .= "<li>Photo de l'installateur</li>";
    $checker = 1;
  }
  if($posted_data['denomination'] == NULL){
      
    $empty_list .= "<li>Nom & Prénom</li>";
    $checker = 1;
  }
  ...
  view::load('installateurs','addinstallateur_ph');
}
?>