<?php
if(MInit::form_verif('editinstallateur', false))//If form is Posted do Action else rend empty form
{
  ...
  $posted_data = array(
   'id'             => Mreq::tp('id') ,
   'type_instal'    => Mreq::tp('type_instal') ,
 ...
 /* if($posted_data['type_instal'] == NULL){
    ...
    $empty_list .= "<li>Photo de l'installateur ou logo de la société</li>";
    $checker = 1;
  }
  ...
  if($posted_data['qualification'] == NULL){
    ...
    $empty_list .= "<li>Qualification Installateur</li>";
    $checker = 1;
  }
  ...
  $new_instal->id_instal = $posted_data['id'];
  //execute Insert returne false if error
  if($new_instal->edit_instal()){
  ...
  view::load('installateurs','editinstallateur');
}
