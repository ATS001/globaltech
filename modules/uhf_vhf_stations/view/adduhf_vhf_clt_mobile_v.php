...
$form = new Mform('adduhf_vhf_clt_mobile', 'adduhf_vhf_clt_mobile', '', 'uhf_vhf_clients&'.MInit::crypt_tp('id', $id_uhf_vhf_stations),'0');
...
$form->input('Matricule','matricule_vehicule', 'text', 6, null, $matricule_vehicule_array);
