...
$form = new Mform('edituhf_vhf_clt_handset', 'edituhf_vhf_clt_handset', $info_uhf_vhf_clients->Shw('id',1),'uhf_vhf_clients&'.MInit::crypt_tp('id',$info_uhf_vhf_clients->Shw('station_base',1)), NULL);
