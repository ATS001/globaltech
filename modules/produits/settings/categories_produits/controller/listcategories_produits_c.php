...
<<<<<<< HEAD
    ...
    // define used table.
	$tables .= " ref_categories_produits";
...
>>>>>>> refs/remotes/origin/ayoub
		...
		$where_etat_line = TableTools::where_etat_line('ref_categories_produits', 'categories_produits');
		//define notif culomn to concatate with any colms.
		//this is change style of button action to red
		$notif_colms = TableTools::line_notif_new('ref_categories_produits', 'categories_produits');
	    $colms .= $notif_colms;
...
<<<<<<< HEAD
		$where_s .=" ( ref_categories_produits.categorie_produit LIKE '%".$serch_value."%' ";   
		$where_s .=" OR (ref_categories_produits.id LIKE '%".$serch_value."%') ";
		$where_s .= TableTools::where_search_etat('ref_categories_produits', 'categories_produits', $serch_value);
    ...
    if( Mreq::tp('export')==1 )
    {
    	...
    	$file_name = 'categories_produits_list';
    	$title     = 'Liste catégories de produits';
...
>>>>>>> refs/remotes/origin/ayoub
	    ...
	    if( Mreq::tp('export')==1 )
	    {
	    	...
	    	if(Mreq::tp('format')=='csv')
	    	{
	    		...
	    		$header    = array('ID'=>5, 'Catégorie de produit'=>30,'Statut'=>25);
	    		Minit::Export_pdf($header, $file_name, $title);
	    	}elseif(Mreq::tp('format')=='dat'){
	    		Minit::send_big_param('categories_produits#'.$sqlTot);
	    	}
