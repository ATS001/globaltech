	...
	$form->input_hidden('idh', Mreq::tp('idh'));
        ...
        $form->select_table('Type', 'idtype', 6, 'ref_types_produits', 'id', 'type_produit', 'type_produit', $indx = '------',$info_categorie_produit->Shw('type_produit',1), $multi = NULL, $where = 'etat= 1', $type_array);
