...
class Mclients {
	...
	public function get_client()
	{
		...
		$sql = "SELECT  c.*,cat.categorie_client as categorie_client, p.pays as pays,v.ville as ville  FROM  clients c,categorie_client cat,ref_pays p,ref_ville v WHERE  c.id_categorie=cat.id and c.id_pays=p.id and c.id_ville=v.id 
