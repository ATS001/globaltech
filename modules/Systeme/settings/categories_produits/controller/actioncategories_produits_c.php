...
$action->action_line_table('Systeme/settings/categories_produits', 'ref_categories_produits',$categorie_produit->categorie_produit_info['creusr'],'deletecategorie_produit');
