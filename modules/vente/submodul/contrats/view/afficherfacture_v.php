...
$info_echeance->get_facture();
$ctr=$info_echeance->facture_info['idcontrat'];

//var_dump($info_echeance->facture_info['idcontrat']);

$info_facture = new Mfacture();
$info_facture->id_facture = $info_echeance->facture_info['id'];
...
<div class="pull-right tableTools-container">
    <div class="btn-group btn-overlap">
        ...
        <?php
        TableTools::btn_add('echeances', 'Liste des échéances', MInit::crypt_tp('id',$ctr), $exec = NULL, 'reply');
        ?>        
