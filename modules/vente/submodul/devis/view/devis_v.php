...
<div class="row">
	<div class="col-xs-12">
		<div class="clearfix">
			<div class="pull-right tableTools-container">
				<div class="btn-group btn-overlap">
						...
						<?php TableTools::btn_add('adddevis','Ajouter un Devis'); ?>
						<?php TableTools::btn_csv('devis','Exporter Liste'); ?>
						<?php TableTools::btn_pdf('devis','Exporter Liste'); ?>
		...
		<div>
			<table id="devis_grid" class="table table-bordered table-condensed table-hover table-striped dataTable no-footer">
				<thead>
					<tr>						
						<th>
							ID
...
$(document).ready(function() {
	...
	var table = $('#devis_grid').DataTable({
		bProcessing: true,
		notifcol : 6,
		serverSide: true,
		ajax_url:"devis",
...
$('#devis_grid').on('click', 'tr button', function() {
	...
	append_drop_menu('devis', table.cell($row, 0).data(), '.btn_action')
});

$('#devis_grid tbody ').on('click', 'tr .this_del', function() {
