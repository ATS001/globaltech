...
/*$js_addfunct .= "$('#table_details_devis tbody ').on('click', 'tr .del_det', function() {
    delet_detail($(this).attr('data'));
});" ;*/    
$form->draw_datatabe_form('table_details_devis', $columns, 'adddevis', 'add_detaildevis', 'Ajouter détails Devis', $js_addfunct);
//Finance bloc
...
$(document).ready(function() {
    ...
    $('#table_details_devis tbody ').on('click', 'tr .del_det', function() {
        ...
        $.ajax({
            ...
            type : 'POST',
            data : '&act=1&exec=delete&'+$id_detail,
            dataType:"html",
