<div class="widget-box transparent">
									<div class="widget-header widget-header-large">
										<h3 class="widget-title grey lighter">
											...
											Etat de compte du client : <?php $info_devis->s('denomination')?>
										</h3>
										...
										<div class="widget-toolbar hidden-480">
											...
											<a href="#" class="report_tplt hide" rel="<?php echo MInit::crypt_tp('tplt', 'compte_client') ?>" data="<?php echo MInit::crypt_tp('id', $info_devis->id_devis) ?>">
										...
										<div class="widget-main padding-24">
											...
											<form id="form_search_range" action="#" class="form-horizontal">
												...
												<div class="form-group">
													<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Période entre:</label>
